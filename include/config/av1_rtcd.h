...
#if CONFIG_AV1_ENCODER && CONFIG_AV1_TEMPORAL_DENOISING
...
RTCD_EXTERN void (*av1_fwd_txfm2d_16x32)(const int16_t* input,
                                         ...
                                         int bd);
#endif
#if defined(__AVX512F__) // HWY
void av1_fwd_txfm2d_16x32_avx2(const int16_t* input,
                                 int32_t* output,
                                 int stride,
                                 TX_TYPE tx_type,
                                 int bd);
...
void av1_fwd_txfm2d_16x32_avx512(const int16_t* input,
                                 int32_t* output,
                                 int stride,
                                 TX_TYPE tx_type,
                                 int bd);
...
#endif
#if defined(__AVX512F__)
void av1_fwd_txfm2d_16x8_avx512(const int16_t* input,
                              int32_t* output,
                              int stride,
                              TX_TYPE tx_type,
                              int bd);
...
#endif
#if defined(__AVX512F__) //HWY
void av1_fwd_txfm2d_32x16_avx2(const int16_t* input,
                                 int32_t* output,
                                 int stride,
                                 TX_TYPE tx_type,
                                 int bd);
#endif
#if defined(__AVX512F__)
void av1_fwd_txfm2d_32x16_avx512(const int16_t* input,
                                 int32_t* output,
                                 int stride,
                                 TX_TYPE tx_type,
                                 int bd);
...
#endif
#if defined(__AVX512F__) // HWY
void av1_fwd_txfm2d_4x8_avx2(const int16_t* input,
                               int32_t* output,
                               int stride,
                               TX_TYPE tx_type,
                               int bd);
#endif
#if defined(__AVX512F__)
void av1_fwd_txfm2d_4x8_avx512(const int16_t* input,
                               int32_t* output,
                               int stride,
                               TX_TYPE tx_type,
                               int bd);
...
#endif
#if defined(__AVX512F__)
void av1_fwd_txfm2d_8x16_avx512(const int16_t* input,
                              int32_t* output,
                              int stride,
                              TX_TYPE tx_type,
                              int bd);
...
#endif
#if defined(__AVX512F__) // HWY
void av1_fwd_txfm2d_8x4_avx2(const int16_t* input,
                               int32_t* output,
                               int stride,
                               TX_TYPE tx_type,
                               int bd);
#endif
#if defined(__AVX512F__)
void av1_fwd_txfm2d_8x4_avx512(const int16_t* input,
                               int32_t* output,
                               int stride,
                               TX_TYPE tx_type,
                               int bd);
...
#endif
#if defined(__AVX512F__)
void av1_lowbd_fwd_txfm_avx512(const int16_t* src_diff,
                             tran_low_t* coeff,
                             int diff_stride,
                             TxfmParam* txfm_param);
#endif
...
#if defined(__SSE3__) && HAVE_SIMD && !CONFIG_EXCLUDE_SIMD_MISMATCH
...
#if CONFIG_AV1_ENCODER && CONFIG_AV1_HIGHBITDEPTH
...
#endif
#endif // CONFIG_AV1_ENCODER && CONFIG_AV1_HIGHBITDEPTH
...
void av1_highbd_convolve_2d_sr_intrabc_c(const uint16_t *src,
                                         int src_stride,
                                         uint16_t *dst,
                                         int dst_stride,
                                         int w,
...
void av1_highbd_convolve_x_sr_intrabc_c(const uint16_t *src,
                                        int src_stride,
                                        uint16_t *dst,
                                        int dst_stride,
                                        int w,
...
void av1_highbd_convolve_y_sr_intrabc_c(const uint16_t *src,
                                        int src_stride,
                                        uint16_t *dst,
                                        int dst_stride,
                                        int w,
...
void av1_apply_temporal_filter_c(const struct yv12_buffer_config *frame_to_filter,
...
#if HAVE_SIMD
#if defined(__SSE2__)
void av1_apply_temporal_filter_sse2(const struct yv12_buffer_config *frame_to_filter,
                                 const struct macroblockd *mbd,
                                 const BLOCK_SIZE block_size,
                                 const int mb_row,
                                 const int mb_col,
...
#if HAVE_SIMD
#if defined(__SSE2__)
void av1_highbd_apply_temporal_filter_sse2(const struct yv12_buffer_config *frame_to_filter,
                                        const struct macroblockd *mbd,
                                        const BLOCK_SIZE block_size,
                                        const int mb_row,
                                        const int mb_col,
...
#if CONFIG_AV1_ENCODER && CONFIG_AV1_HIGHBITDEPTH && !CONFIG_REALTIME_ONLY
...
#endif
#endif // CONFIG_AV1_ENCODER && CONFIG_AV1_HIGHBITDEPTH && CONFIG_REALTIME_ONLY
