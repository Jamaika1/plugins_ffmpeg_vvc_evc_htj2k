...
#define aom_highbd_lpf_vertical_generic_ aom_highbd_lpf_vertical_generic__c
...
#if HAVE_SIMD
    void aom_fdct4x4_lp_sse2(const int16_t *input, tran_low_t *output, int stride);
...
#if HAVE_SIMD
  RTCD_EXTERN uint64_t (*aom_var_2d_u8)(const int16_t *src, int stride, int width, int height);
  uint64_t aom_var_2d_u8_sse2(const int16_t *src, int stride, int width, int height);
#if defined(__AVX2__)
  uint64_t aom_var_2d_u8_avx2(const int16_t *src, int stride, int width, int height);
#endif
#else
...
#if HAVE_SIMD
  RTCD_EXTERN uint64_t (*aom_var_2d_u16)(const int16_t *src, int stride, int width, int height);
  uint64_t aom_var_2d_u16_sse2(const int16_t *src, int stride, int width, int height);
#if defined(__AVX2__)
  uint64_t aom_var_2d_u16_avx2(const int16_t *src, int stride, int width, int height);
#endif
#else
