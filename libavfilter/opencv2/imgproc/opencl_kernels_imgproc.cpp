...
namespace cv::ocl::imgproc
{

ProgramSource accumulate_oclsrc = ProgramSource("\
...
ProgramSource bilateral_oclsrc = ProgramSource("\
#if cn != 3\n\
...
ProgramSource blend_linear_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource boxFilter_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource boxFilter3x3_oclsrc = ProgramSource("\
...
ProgramSource calc_back_project_oclsrc = ProgramSource("\
...
ProgramSource canny_oclsrc = ProgramSource("\
...
ProgramSource clahe_oclsrc = ProgramSource("\
...
ProgramSource color_hsv_oclsrc = ProgramSource("\
#if SRC_DEPTH == 0\n\
...
ProgramSource color_lab_oclsrc = ProgramSource("\
#if SRC_DEPTH == 0\n\
    #define DATA_TYPE uchar\n\
    #define MAX_NUM  255\n\
    #define HALF_MAX_NUM 128\n\
...
ProgramSource color_rgb_oclsrc = ProgramSource("\
#if SRC_DEPTH == 0\n\
    #define DATA_TYPE uchar\n\
    #define MAX_NUM  255\n\
    #define HALF_MAX_NUM 128\n\
...
ProgramSource color_yuv_oclsrc = ProgramSource("\
#if SRC_DEPTH == 0\n\
    #define DATA_TYPE uchar\n\
    #define MAX_NUM  255\n\
    #define HALF_MAX_NUM 128\n\
...
ProgramSource corner_oclsrc = ProgramSource("\
#ifdef BORDER_CONSTANT\n\
#elif defined BORDER_REPLICATE\n\
...
ProgramSource covardata_oclsrc = ProgramSource("\
#ifdef BORDER_CONSTANT\n\
...
ProgramSource filter2D_oclsrc = ProgramSource("\
...
ProgramSource filter2DSmall_oclsrc = ProgramSource("\
...
ProgramSource filterSep_singlePass_oclsrc = ProgramSource("\
#ifdef BORDER_CONSTANT\n\
// CCCCCC|abcdefgh|CCCCCCC\n\
#define EXTRAPOLATE(x, maxV)\n\
#elif defined BORDER_REPLICATE\n\
...
ProgramSource filterSepCol_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource filterSepRow_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource filterSmall_oclsrc = ProgramSource("\
#ifdef BORDER_REPLICATE\n\
//BORDER_REPLICATE:     aaaaaa|abcdefgh|hhhhhhh\n\
#define ADDR_L(i, l_edge, r_edge)  ((i) <  (l_edge) ? (l_edge)   : (i))\n\
#define ADDR_R(i, r_edge, addr)    ((i) >= (r_edge) ? (r_edge)-1 : (addr))\n\
...
ProgramSource gaussianBlur3x3_oclsrc = ProgramSource("\
#define DIG(a) a,\n\
...
ProgramSource gaussianBlur5x5_oclsrc = ProgramSource("\
#define DIG(a) a,\n\
__constant float kx[] = { KERNEL_MATRIX_X };\n\
__constant float ky[] = { KERNEL_MATRIX_Y };\n\
\n\
...
ProgramSource gftt_oclsrc = ProgramSource("\
...
ProgramSource histogram_oclsrc = ProgramSource("\
#ifndef kercn\n\
#define kercn 1\n\
#endif\n\
\n\
...
ProgramSource hough_lines_oclsrc = ProgramSource("\
...
ProgramSource integral_sum_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource laplacian3_oclsrc = ProgramSource("\
#define DIG(a) a,\n\
...
ProgramSource laplacian5_oclsrc = ProgramSource("\
#define noconvert\n\
\n\
...
ProgramSource match_template_oclsrc = ProgramSource("\
#if cn != 3\n\
...
ProgramSource medianFilter_oclsrc = ProgramSource("\
#if cn != 3\n\
#define loadpix(addr) *(__global const T *)(addr)\n\
...
ProgramSource moments_oclsrc = ProgramSource("\
#if TILE_SIZE != 32\n\
...
ProgramSource morph_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource morph3x3_oclsrc = ProgramSource("\
#ifdef OP_ERODE\n\
...
ProgramSource precornerdetect_oclsrc = ProgramSource("\
...
ProgramSource pyr_down_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource pyr_up_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource pyramid_up_oclsrc = ProgramSource("\
...
ProgramSource remap_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource resize_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource sepFilter3x3_oclsrc = ProgramSource("\
#define DIG(a) a,\n\
__constant float kx[] = { KERNEL_MATRIX_X };\n\
__constant float ky[] = { KERNEL_MATRIX_Y };\n\
\n\
...
ProgramSource threshold_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource threshold_mask_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource warp_affine_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource warp_perspective_oclsrc = ProgramSource("\
#ifdef DOUBLE_SUPPORT\n\
#ifdef cl_amd_fp64\n\
#pragma OPENCL EXTENSION cl_amd_fp64:enable\n\
#elif defined (cl_khr_fp64)\n\
...
ProgramSource warp_transform_oclsrc = ProgramSource("\
