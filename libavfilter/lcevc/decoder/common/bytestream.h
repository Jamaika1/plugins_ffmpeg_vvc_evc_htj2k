...
#ifndef VN_LCEVC_LEGACY_BYTESTREAM_H
#define VN_LCEVC_LEGACY_BYTESTREAM_H
...
size_t ldlByteStreamGetSize(const ByteStream_t* stream);
...
#endif // VN_LCEVC_LEGACY_BYTESTREAM_H
