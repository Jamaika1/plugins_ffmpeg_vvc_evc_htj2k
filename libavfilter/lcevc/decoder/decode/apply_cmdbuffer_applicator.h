...
#ifndef VN_LCEVC_LEGACY_APPLY_CMDBUFFER_APPLICATOR_H
#define VN_LCEVC_LEGACY_APPLY_CMDBUFFER_APPLICATOR_H
...
#endif // VN_LCEVC_LEGACY_APPLY_CMDBUFFER_APPLICATOR_H
