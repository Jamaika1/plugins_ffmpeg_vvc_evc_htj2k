...
#define cmdBufferApplicatorBlockTemplate ldlCmdBufferApplicatorBlockScalar
#define cmdBufferApplicatorSurfaceTemplate ldlCmdBufferApplicatorSurfaceScalar
