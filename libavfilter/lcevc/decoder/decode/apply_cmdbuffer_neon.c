...
static inline void addDD_U8(const ApplyCmdBufferArgs_t* args)
{
    ...
    assert(!ldlFixedPointIsSigned(args->surface->type));
...
#define cmdBufferApplicatorBlockTemplate ldlCmdBufferApplicatorBlockNEON
#define cmdBufferApplicatorSurfaceTemplate ldlCmdBufferApplicatorSurfaceNEON
