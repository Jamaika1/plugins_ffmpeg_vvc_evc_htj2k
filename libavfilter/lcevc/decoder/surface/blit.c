...
int32_t ldlBlitSlicedJob(const void* executeContext, JobIndex_t index, SliceOffset_t offset)
{
    VN_UNUSED(index);
                 ...
                 const Surface_t* src, const Surface_t* dst, BlendingMode_t blending)
{
    ...
    return threadingExecuteSlicedJobs(threadManager, &ldlBlitSlicedJob, &slicedJobContext,
