...
static void ldlHorizontalU8PlanarSSE(Dither_t dither, const uint8_t* in[2], uint8_t* out[2],
...
static void ldlHorizontalS16PlanarSSE(Dither_t dither, const uint8_t* in[2], uint8_t* out[2],
                                      const uint8_t* base[2], uint32_t width, uint32_t xStart,
                                      uint32_t xEnd, const Kernel_t* kernel)
{
    const int16_t* kernelCoeffs = kernel->coeffs[0];
...
static inline void ldlHorizontalU16PlanarSSE(Dither_t dither, const uint8_t* in[2], uint8_t* out[2],
                                             const uint8_t* base[2], uint32_t width,
                                             uint32_t xStart, uint32_t xEnd, const Kernel_t* kernel,
                                             int16_t maxValue, bool is14Bit)
{
    const int16_t* kernelCoeffs = kernel->coeffs[0];
    const uint32_t kernelLength = kernel->length;
    __m128i pels[2][2];
...
static void ldlHorizontalU10PlanarSSE(Dither_t dither, const uint8_t* in[2], uint8_t* out[2],
                                      const uint8_t* base[2], uint32_t width, uint32_t xStart,
                                      uint32_t xEnd, const Kernel_t* kernel)
{
    ldlHorizontalU16PlanarSSE(dither, in, out, base, width, xStart, xEnd, kernel, 1023, false);
}

/*! \brief U12 Planar horizontal upscaling of 2 rows. */
static void ldlHorizontalU12PlanarSSE(Dither_t dither, const uint8_t* in[2], uint8_t* out[2],
                                      const uint8_t* base[2], uint32_t width, uint32_t xStart,
                                      uint32_t xEnd, const Kernel_t* kernel)
{
    ldlHorizontalU16PlanarSSE(dither, in, out, base, width, xStart, xEnd, kernel, 4095, false);
}

/*! \brief U14 Planar horizontal upscaling of 2 rows. */
static void ldlHorizontalU14PlanarSSE(Dither_t dither, const uint8_t* in[2], uint8_t* out[2],
                                      const uint8_t* base[2], uint32_t width, uint32_t xStart,
                                      uint32_t xEnd, const Kernel_t* kernel)
{
    ldlHorizontalU16PlanarSSE(dither, in, out, base, width, xStart, xEnd, kernel, 16383, true);
}

/*! \brief NV12 horizontal upscaling of 2 rows. */
static void ldlHorizontalU8NV12SSE(Dither_t dither, const uint8_t* in[2], uint8_t* out[2],
                                   const uint8_t* base[2], uint32_t width, uint32_t xStart,
                                   uint32_t xEnd, const Kernel_t* kernel)
{
    const int16_t* kernelCoeffs = kernel->coeffs[0];
...
void ldlVerticalU8SSE(const uint8_t* in, uint32_t inStride, uint8_t* out, uint32_t outStride,
...
void ldlVerticalS16SSE(const uint8_t* in, uint32_t inStride, uint8_t* out, uint32_t outStride,
                       uint32_t y, uint32_t rows, uint32_t height, const Kernel_t* kernel)
{
    __m128i kernelFwd[UCInterleavedStore];
    __m128i kernelRev[UCInterleavedStore];
...
static void ldlVerticalU16SSE(const uint8_t* in, uint32_t inStride, uint8_t* out,
...
static void ldlVerticalU10SSE(const uint8_t* in, uint32_t inStride, uint8_t* out, uint32_t outStride,
                              uint32_t y, uint32_t rows, uint32_t height, const Kernel_t* kernel)
{
    ldlVerticalU16SSE(in, inStride, out, outStride, y, rows, height, kernel, 1023);
}

static void ldlVerticalU12SSE(const uint8_t* in, uint32_t inStride, uint8_t* out, uint32_t outStride,
                              uint32_t y, uint32_t rows, uint32_t height, const Kernel_t* kernel)
{
    ldlVerticalU16SSE(in, inStride, out, outStride, y, rows, height, kernel, 4095);
}

static void ldlVerticalU14SSE(const uint8_t* in, uint32_t inStride, uint8_t* out, uint32_t outStride,
                              uint32_t y, uint32_t rows, uint32_t height, const Kernel_t* kernel)
{
    ldlVerticalU16SSE(in, inStride, out, outStride, y, rows, height, kernel, 16383);
}
...
static const UpscaleHorizontal_t kHorizontalFunctionTable[ILCount][FPCount] = {
    ...
    {ldlHorizontalU8PlanarSSE, ldlHorizontalU10PlanarSSE, ldlHorizontalU12PlanarSSE, ldlHorizontalU14PlanarSSE, ldlHorizontalS16PlanarSSE, ldlHorizontalS16PlanarSSE, ldlHorizontalS16PlanarSSE, ldlHorizontalS16PlanarSSE}, /* None*/
    {NULL,                     NULL,                      NULL,                      NULL,                      NULL,                      NULL,                      NULL,                      NULL},                      /* YUYV */
    {ldlHorizontalU8NV12SSE,   NULL,                      NULL,                      NULL,                      NULL,                      NULL,                      NULL,                      NULL},                      /* NV12 */
...
static const UpscaleVertical_t kVerticalFunctionTable[FPCount] = {
    ldlVerticalU8SSE,    /* U8 */
    ldlVerticalU10SSE,   /* U10 */
    ldlVerticalU12SSE,   /* U12 */
    ldlVerticalU14SSE,   /* U14 */
    ldlVerticalS16SSE, /* S8.7 */
    ldlVerticalS16SSE, /* S10.5 */
    ldlVerticalS16SSE, /* S12.3 */
    ldlVerticalS16SSE, /* S14.1 */
};
