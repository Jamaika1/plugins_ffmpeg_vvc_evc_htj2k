...
#ifndef VN_LCEVC_COLOR_CONVERSION_TONEMAP_H
#define VN_LCEVC_COLOR_CONVERSION_TONEMAP_H

#include "../decoder/PerseusDecoder.h"
#include <stdbool.h>
#include <stdint.h>
...
#endif // VN_LCEVC_COLOR_CONVERSION_TONEMAP_H
