...
cd ../../..
cd librsvg/fribidi
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DFRIBIDI_LIB_STATIC=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGIZE=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/harfbuzz
...
cd ../..
cd librsvg/libxml2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DLIBXML_STATIC=1 -DHAVE_PTHREAD_H=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/cairo
...
cd librsvg
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -DRSVG_STATIC=1 -DRSVG_COMPILATION=1 -c %%f -o %%~nf.o
cd ..
cd librsvg/glib
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DPCRE2_STATIC=1 -DPCRE2_CODE_UNIT_WIDTH=8 -DNHAVE_ERRNO_H -UHAVE_STDINT_H -DPTW32_STATIC_LIB=1 -DHAVE_PTHREAD_CONDATTR_SETCLOCK=1 -DCLOCK_MONOTONIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gio
...
cd ../..
cd librsvg/gobject
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gdk-pixbuf
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gmodule
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
cd ../..
...
cd librsvg/libffi
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_CONFIG_H=1 -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -DNHAVE_ERRNO_H -UHAVE_STDINT_H -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
...
cd ..
cd libxavs2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -UHAVE_STDINT_H -DHAVE_LOG2F=1 -c %%f -o %%~nf.o
cd ..
cd libxavs2/vec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -UHAVE_STDINT_H -DHAVE_LOG2F=1 -c %%f -o %%~nf.o
cd ../..
...
cd libaom/aom
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../..
cd libaom/av1c
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd librsvg/harfbuzz
ar.exe -r -s -c --target=pe-bigobj-x86-64 "../../../lib/harfbuzz_x64.a" harfbuzz.o
cd ../..
cd librsvg
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -DWIN32_LEAN_AND_MEAN=/"/" -c %%f -o %%~nf.o
cd ..
g++.exe -std=gnu++11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -o "lib/ffmpeg_rsvg.exe" fftools/ffmpeg.o fftools/ffmpeg_dec.o fftools/ffmpeg_demux.o fftools/ffmpeg_enc.o fftools/ffmpeg_filter.o fftools/ffmpeg_hw.o fftools/ffmpeg_mux.o fftools/ffmpeg_mux_init.o fftools/ffmpeg_opt.o fftools/cmdutils.o fftools/objpool.o fftools/opt_common.o fftools/sync_queue.o fftools/thread_queue.o -Llib -lavdevice_x64 -lavfilter_x64 -lavformat_x64 -lavcodec_x64 -lswresample_x64 -lswscale_x64 -lavutil_x64 -lpostproc_x64 -lavm_x64 -lcelt_opus_silk_x64 -lcelt_x64 -lcodec2_x64 -ldav1d_x64 -ljxl_x64 -lkvazaar_x64 -llcms2_x64 -lopenh264_x64 -lopenjpeg_x64 -lfdk-aac_x64 -lsvtav1_x64 -luavs3d_x64 -luavs3e_x64 -lwebp_x64 -lx264_0810bit_x64 -lx265_081012bit_x64 -lxavs_x64 -lxavs2_x64 -lxevd_x64 -lxeve_x64 -lxvid_x64 -lvorbis_x64 -ltwolame_x64 -ltheora_x64 -lspeex_x64 -lsnappy_x64 -lshine_x64 -lmp3lame_x64 -lgsm_x64 -ldavs2_x64 -lvpx_x64 -luvg266_x64 -logg_x64 -lrsvgdec_x64 -lcairo_pixman_x64 -lpthread_x64 -lpng_x64 -lass_x64 -l:fontconfig_x64.a -l:freetype_x64.a -l:fribidi_x64.a -l:harfbuzz_x64.a -lxml2_x64 -l:zlib_x64.a -l:bzip2_x64.a -l:lzma_x64.a -L. -lcfgmgr32 -ldnsapi -ldwrite -lbcrypt -liphlpapi -lgdi32 -lopengl32 -lole32 -loleaut32 -lshlwapi -lstrmiids -luuid -lvfw32 -lws2_32
cd lib
...
cd ..
g++.exe -std=gnu++11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -o "lib/ffplay_rsvg.exe" fftools/ffplay.o fftools/cmdutils.o fftools/opt_common.o -Llib -lavdevice_x64 -lavfilter_x64 -lavformat_x64 -lavcodec_x64 -lswresample_x64 -lswscale_x64 -lavutil_x64 -lpostproc_x64 -lsdl2_x64 -lavm_x64 -lcelt_opus_silk_x64 -lcelt_x64 -lcodec2_x64 -ldav1d_x64 -ljxl_x64 -lkvazaar_x64 -llcms2_x64 -lopenh264_x64 -lopenjpeg_x64 -lfdk-aac_x64 -lsvtav1_x64 -luavs3d_x64 -luavs3e_x64 -lwebp_x64 -lx264_0810bit_x64 -lx265_081012bit_x64 -lxavs_x64 -lxavs2_x64 -lxevd_x64 -lxeve_x64 -lxvid_x64 -lvorbis_x64 -ltwolame_x64 -ltheora_x64 -lspeex_x64 -lsnappy_x64 -lshine_x64 -lmp3lame_x64 -lgsm_x64 -ldavs2_x64 -lvpx_x64 -luvg266_x64 -logg_x64 -lrsvgdec_x64 -lcairo_pixman_x64 -lpthread_x64 -lpng_x64 -lass_x64 -l:fontconfig_x64.a -l:freetype_x64.a -l:fribidi_x64.a -l:harfbuzz_x64.a -lxml2_x64 -l:zlib_x64.a -l:bzip2_x64.a -l:lzma_x64.a -L. -lbcrypt -ldnsapi -ldwrite -lgdi32 -lopengl32 -liphlpapi -limm32 -lole32 -loleaut32 -lshcore -lsetupapi -lstrmiids -lshlwapi -luuid -lversion -lvfw32 -lwinmm -lws2_32
pause
