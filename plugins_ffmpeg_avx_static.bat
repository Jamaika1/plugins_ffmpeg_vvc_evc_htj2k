...
cd ../..
cd librsvg/harfbuzz
for %%f in ("harfbuzz.cc") do g++.exe -std=gnu++11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -DFRIBIDI_LIB_STATIC=1 -DHAVE_CAIRO=1 -DHAVE_FREETYPE=1 -DHAVE_GLIB=1 -DHAVE_GOBJECT=1 -DDONT_HAVE_FRIBIDI_UNICODE_VERSION_H -c %%f -o %%~nf.o
cd ../..
cd librsvg/libxml2
...
cd ../..
cd librsvg/pango
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DFRIBIDI_LIB_STATIC=1 -DLIBXML_STATIC=1 -DSYSCONFDIR=\"/etc\" -DLIBDIR=\"/pango\" -DDONT_HAVE_FRIBIDI_UNICODE_VERSION_H -DFT_FREETYPE_H="<freetype/freetype.h>" -c %%f -o %%~nf.o
...
cd ..
cd libtheora/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DCAIRO_WIN32_STATIC_BUILD=1 -DHAVE_CAIRO=1 -DOC_DUMP_IMAGES=1 -DNOC_COLLECT_METRICS -DNHAVE_MEMORY_CONSTRAINT -DOC_STATE_USE_VTABLE=1 -DOC_X86_ASM=1 -DOC_X86_64_ASM=1 -DNOC_DUMP_IMAGES -c %%f -o %%~nf.o
cd ../..
cd libtheora
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DCAIRO_WIN32_STATIC_BUILD=1 -DHAVE_CAIRO=1 -DOC_DUMP_IMAGES=1 -DNOC_COLLECT_METRICS -DNHAVE_MEMORY_CONSTRAINT -DOC_STATE_USE_VTABLE=1 -DOC_X86_ASM=1 -DOC_X86_64_ASM=1 -DNOC_DUMP_IMAGES -c %%f -o %%~nf.o
cd ..
...
cd ../../..
cd librsvg/fribidi
ar.exe rcs "../../../lib/fribidi_x64.a" fribidi\fribidi.o fribidi\fribidi-bidi.o fribidi\fribidi-bidi-types.o fribidi\fribidi-char-sets.o fribidi\fribidi-char-sets-cap-rtl.o fribidi\fribidi-char-sets-cp1255.o fribidi\fribidi-char-sets-cp1256.o fribidi\fribidi-char-sets-iso8859-6.o fribidi\fribidi-char-sets-iso8859-8.o fribidi\fribidi-char-sets-utf8.o fribidi\fribidi-deprecated.o fribidi\fribidi-joining-types.o fribidi\fribidi-run.o fribidi\fribidi-brackets.o fribidi\fribidi-joining.o fribidi\fribidi-mirroring.o fribidi\fribidi-shape.o fribidi\fribidi-arabic.o 
cd ../../..
cd librsvg/harfbuzz
