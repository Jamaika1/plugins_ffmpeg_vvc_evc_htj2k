...
cd ..
cd libx265/vec
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+108-a55e756 -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
cd libx265_10bit/vec
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=0 -DX265_NS=x265_10bit -DX86_64=1 -DX265_VERSION=3.5+108-a55e756 -DHIGH_BIT_DEPTH=1 -DX265_DEPTH=10 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
cd libx265_12bit/vec
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=0 -DX265_NS=x265_12bit -DX86_64=1 -DX265_VERSION=3.5+108-a55e756 -DHIGH_BIT_DEPTH=1 -DX265_DEPTH=12 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
cd libx265
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+108-a55e756 -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ..
...
cd ../..
cd libx265/x86
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+108-a55e756 -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DNX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
