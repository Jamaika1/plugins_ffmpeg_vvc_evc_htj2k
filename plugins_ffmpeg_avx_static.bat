...
cd ../..
cd librsvg/harfbuzz
for %%f in ("harfbuzz.cc") do g++.exe -std=gnu++11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -DHAVE_CAIRO=1 -DHAVE_FREETYPE=1 -DHAVE_GLIB=1 -DHAVE_GOBJECT=1 -DHAVE_PTHREAD=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/libxml2
...
cd librsvg/libffi
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_CONFIG_H=1 -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
...
cd ../..
cd librsvg/lzma
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_STDBOOL_H=1 -DHAVE_STDINT_H=1 -DMYTHREAD_ENABLED=1 -DMYTHREAD_VISTA=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/bzip2
...
cd ../../..
cd libkvazaar
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DKVZ_BIT_DEPTH=8 -DKVZ_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -c %%f -o %%~nf.o
cd ..
cd libkvazaar/altivec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DKVZ_BIT_DEPTH=8 -DKVZ_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
...
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DKVZ_BIT_DEPTH=8 -DKVZ_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
echo cd ../..
cd libuvg266
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_BIT_DEPTH=8 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -c %%f -o %%~nf.o
cd ..
cd libuvg266/altivec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_BIT_DEPTH=8 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
cd libuvg266/sse2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_BIT_DEPTH=8 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libpthread_win32
for %%f in ("pthread.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_CONFIG_H=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ..
cd libopenjpeg
...
cd ..
cd libxavs
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DNHAVE_MMX -DARCH_X86_64=1 -DNHAVE_MMXEXT -DNHAVE_SSE2 -DNHAVE_SSSE3 -DNHAVE_SSE4 -DXAVS_VERSION=1 -DMP4_OUTPUT=1 -DHAVE_STDINT_H=1 -D__WIN32__=1 -c %%f -o %%~nf.o
cd ..
cd libxavs2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -c %%f -o %%~nf.o
cd ..
cd libxavs2/vec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -c %%f -o %%~nf.o
cd ../..
...
cd libx264
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DHIGH_BIT_DEPTH=0 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -DHAVE_X86_INLINE_ASM=1 -c %%f -o %%~nf.o
cd ..
cd libx264_10bit
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DWIN32 -DWIN64 -c %%f -o %%~nf.o
