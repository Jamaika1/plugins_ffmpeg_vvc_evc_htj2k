...
cd libavfilter
cd libass
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DARCH_X86=1 -DCONFIG_ASM=1 -DCONFIG_FONTCONFIG=1 -DCONFIG_LARGE_TILES=1 -DCONFIG_SOURCEVERSION=\"0.17.1\" -c %%f -o %%~nf.o
cd x86
