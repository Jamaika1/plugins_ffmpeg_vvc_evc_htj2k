...
cd libavcodec
echo cd librsvg
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DRSVG_STATIC=1 -DRSVG_COMPILATION=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
echo cd ..
echo cd librsvg/glib
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DPCRE2_STATIC=1 -c %%f -o %%~nf.o
echo cd ../..
echo cd librsvg/gio
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DPCRE2_STATIC=1 -c %%f -o %%~nf.o
echo cd ../..
echo cd librsvg/gdk-pixbuf
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
echo cd ../..
echo cd librsvg/gmodule
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
echo cd ../..
echo cd librsvg/gvdb
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
echo cd ../..
echo cd librsvg/harfbuzz
echo for %%f in ("harfbuzz.cc") do g++.exe -std=gnu++11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -DFRIBIDI_LIB_STATIC=1 -DHAVE_CAIRO=1 -DHAVE_GLIB=1 -DHAVE_GOBJECT=1 -DSYSCONFDIR=\"\" -DLIBDIR=\"\" -DDONT_HAVE_FRIBIDI_UNICODE_VERSION_H -c %%f -o %%~nf.o
echo cd ../..
echo cd librsvg/pcre2
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DPCRE2_STATIC=1 -DPCRE2_CODE_UNIT_WIDTH=8 -DHAVE_CONFIG_H -c %%f -o %%~nf.o
echo cd ../..
cd librsvg/libxml2
...
echo cd ../..
echo cd librsvg/libffi
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -c %%f -o %%~nf.o
...
echo cd ../..
echo cd librsvg/fribidi
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DFRIBIDI_LIB_STATIC=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGIZE=1 -DDONT_HAVE_FRIBIDI_UNICODE_VERSION_H=1 -c %%f -o %%~nf.o
echo cd ../..
cd librsvg/libpng
...
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DNIN_LIBASPRINTF -DNO_XMALLOC -DHAVE_CONFIG_H -DHAVE_STDINT_H_WITH_UINTMAX -DHAVE_GETCWD -DUSE_WINDOWS_THREADS=1 -DHAVE_MEMPCPY=1 -DHAVE_TSEARCH=1 -DNSTATIC="" -DLOCALEDIR=\"\" -DLOCALE_ALIAS_PATH=\"\" -DLIBDIR=\"\" -DIN_LIBINTL -DLIBINTL_VERSION=0x001308 -DNWIDE_CHAR_VERSION -c %%f -o %%~nf.o
echo cd ../..
cd librsvg/cairo
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
echo cd librsvg/libcroco
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
echo cd ../..
echo cd librsvg/pango
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DFRIBIDI_LIB_STATIC=1 -DLIBXML_STATIC=1 -DSYSCONFDIR=\"\" -DLIBDIR=\"\" -DDONT_HAVE_FRIBIDI_UNICODE_VERSION_H -c %%f -o %%~nf.o
echo for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DFRIBIDI_LIB_STATIC=1 -DLIBXML_STATIC=1 -DSYSCONFDIR=\"\" -DLIBDIR=\"\" -DDONT_HAVE_FRIBIDI_UNICODE_VERSION_H -c %%f -o %%~nf.o
echo cd ../..
cd librsvg/pixman
...
cd ..
cd libtheora/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DCAIRO_WIN32_STATIC_BUILD=1 -DHAVE_CAIRO=1 -DNOC_COLLECT_METRICS -DHAVE_MEMORY_CONSTRAINT=1 -DOC_STATE_USE_VTABLE=1 -DOC_X86_ASM=1 -DOC_X86_64_ASM=1 -DNOC_DUMP_IMAGES -c %%f -o %%~nf.o
cd ../..
cd libtheora
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -DCAIRO_WIN32_STATIC_BUILD=1 -DHAVE_CAIRO=1 -DNOC_COLLECT_METRICS -DHAVE_MEMORY_CONSTRAINT=1 -DOC_STATE_USE_VTABLE=1 -DOC_X86_ASM=1 -DOC_X86_64_ASM=1 -DNOC_DUMP_IMAGES -c %%f -o %%~nf.o
cd ..
...
ar.exe rcs "../lib/libavdevice_x64.a" alldevices.o avdevice.o dshow.o dshow_common.o dshow_crossbar.o dshow_enummediatypes.o dshow_enumpins.o dshow_filter.o dshow_pin.o gdigrab.o lavfi.o reverse.o sdl2.o timefilter.o utils.o version.o vfwcap.o 
cd ..
g++.exe -std=gnu++11 -march=x86-64-v2 -ftree-vectorize -g0 -O3 -fPIC -mavx -mxsave -mpclmul -maes -o "lib/ffplay.exe" fftools/ffplay.o fftools/cmdutils.o fftools/opt_common.o -Llib -lsdl2_x64 -lavdevice_x64 -lavfilter_x64 -lavformat_x64 -lavcodec_x64 -lswresample_x64 -lswscale_x64 -lavutil_x64 -lpostproc_x64 -laom_x64 -laribb24_x64 -lcelt_opus_silk_x64 -lcelt_x64 -lcodec2_x64 -ldav1d_x64 -ljxl_x64 -lkvazaar_x64 -llcms2_x64 -lopenh264_x64 -lopenjpeg_x64 -lsvtav1_x64 -luavs3d_x64 -luavs3e_x64 -lwebp_x64 -lx264_0810bit_x64 -lx265_081012bit_x64 -lxavs_x64 -lxavs2_x64 -lxevd_x64 -lxeve_x64 -lxvid_x64 -lvorbis_x64 -ltwolame_x64 -ltheora_x64 -lspeex_x64 -lsnappy_x64 -lshine_x64 -lmp3lame_x64 -lgsm_x64 -ldavs2_x64 -lvpx_x64 -lcairo_pixman_x64 -luvg266_x64 -lrsvg_x64 -lxml2_x64 -logg_x64 -lpthread_x64 -l:zlib_x64.a -L. -lbcrypt -ldnsapi -ldwrite -lgdi32 -liphlpapi -limm32 -lole32 -loleaut32 -lshcore -lsetupapi -lstrmiids -lshlwapi -luuid -lversion -lvfw32 -lwinmm -lws2_32 
pause
