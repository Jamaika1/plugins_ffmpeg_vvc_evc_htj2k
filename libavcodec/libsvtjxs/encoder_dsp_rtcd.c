...
#if defined(__AVX2__)
#include "ASM_AVX2/NltEnc_avx2.h"
#endif
#include "DwtStageProcess.h"
#if defined(__AVX512F__)
#include "ASM_AVX512/Enc_avx512.h"
#endif
#include "GcStageProcess.h"
#include "Dwt.h"
#if defined(__AVX2__)
#include "ASM_AVX2/Dwt_AVX2.h"
#endif
#include "NltEnc.h"
#include "ASM_SSE4_1/Quant_sse4_1.h"
#if defined(__AVX2__)
#include "ASM_AVX2/Quant_avx2.h"
#endif
#include "Quant.h"
#include "PackPrecinct.h"
#if defined(__AVX512F__)
#include "ASM_AVX512/Pack_avx512.h"
#endif
#include "ASM_SSE4_1/group_coding_sse4_1.h"
#include "RateControl.h"
#if defined(__AVX2__)
#include "ASM_AVX2/RateControl_avx2.h"
#endif
...
void setup_encoder_rtcd_internal(CPU_FLAGS flags) {
    ...
    SET_AVX2_AVX512(gc_precinct_stage_scalar,
                    gc_precinct_stage_scalar_c,
                    gc_precinct_stage_scalar_avx2,
                    gc_precinct_stage_scalar_avx512);
    ...
    SET_AVX2(image_shift, image_shift_c, image_shift_avx2);
    SET_AVX2(dwt_horizontal_line, dwt_horizontal_line_c, dwt_horizontal_line_avx2);

    SET_AVX2(transform_V1_Hx_precinct_recalc_HF_prev,
                    transform_V1_Hx_precinct_recalc_HF_prev_c,
                    transform_V1_Hx_precinct_recalc_HF_prev_avx2);
    SET_AVX2(transform_vertical_loop_hf_line_0,
                    transform_vertical_loop_hf_line_0_c,
                    transform_vertical_loop_hf_line_0_avx2);
    SET_AVX2(transform_vertical_loop_lf_line_0,
                    transform_vertical_loop_lf_line_0_c,
                    transform_vertical_loop_lf_line_0_avx2);
    SET_AVX2(transform_vertical_loop_lf_hf_line_0,
                    transform_vertical_loop_lf_hf_line_0_c,
                    transform_vertical_loop_lf_hf_line_0_avx2);
    SET_AVX2(transform_vertical_loop_lf_hf_line_x_prev,
                    transform_vertical_loop_lf_hf_line_x_prev_c,
                    transform_vertical_loop_lf_hf_line_x_prev_avx2);
    SET_AVX2(transform_vertical_loop_lf_hf_hf_line_x,
                    transform_vertical_loop_lf_hf_hf_line_x_c,
                    transform_vertical_loop_lf_hf_hf_line_x_avx2);
    SET_AVX2(transform_vertical_loop_lf_hf_hf_line_last_even,
                    transform_vertical_loop_lf_hf_hf_line_last_even_c,
                    transform_vertical_loop_lf_hf_hf_line_last_even_avx2);
    SET_AVX2(linear_input_scaling_line_8bit,
                    linear_input_scaling_line_8bit_c,
                    linear_input_scaling_line_8bit_avx2);
    SET_AVX2(linear_input_scaling_line_16bit,
                    linear_input_scaling_line_16bit_c,
                    linear_input_scaling_line_16bit_avx2);
    SET_AVX2(pack_data_single_group, pack_data_single_group_c, NULL);
    SET_AVX2(rate_control_calc_vpred_cost_nosigf,
                    rate_control_calc_vpred_cost_nosigf_c,
                    rate_control_calc_vpred_cost_nosigf_avx2);
    SET_AVX2(convert_packed_to_planar_rgb_8bit,
                    convert_packed_to_planar_rgb_8bit_c,
                    convert_packed_to_planar_rgb_8bit_avx2);
    SET_AVX2(convert_packed_to_planar_rgb_16bit,
                    convert_packed_to_planar_rgb_16bit_c,
                    convert_packed_to_planar_rgb_16bit_avx2);
    SET_SSE2(gc_precinct_stage_scalar_loop, gc_precinct_stage_scalar_loop_c, gc_precinct_stage_scalar_loop_ASM);
    SET_SSE41(gc_precinct_sigflags_max, gc_precinct_sigflags_max_c, gc_precinct_sigflags_max_sse4_1);
    SET_ONLY_C(rate_control_calc_vpred_cost_sigf_nosigf,
               rate_control_calc_vpred_cost_sigf_nosigf_c);
#else
    //SET_SSE41(quantization, quantization_c, quantization_sse4_1);
    SET_ONLY_C(quantization, quantization_c);

    //SET_SSE2(gc_precinct_stage_scalar_loop, gc_precinct_stage_scalar_loop_c, gc_precinct_stage_scalar_loop_ASM);
    SET_ONLY_C(gc_precinct_stage_scalar_loop, gc_precinct_stage_scalar_loop_c);
    //SET_SSE41(gc_precinct_sigflags_max, gc_precinct_sigflags_max_c, gc_precinct_sigflags_max_sse4_1);
    SET_ONLY_C(gc_precinct_sigflags_max, gc_precinct_sigflags_max_c);
    SET_ONLY_C(image_shift, image_shift_c);
    SET_ONLY_C(dwt_horizontal_line, dwt_horizontal_line_c);

    SET_ONLY_C(transform_V1_Hx_precinct_recalc_HF_prev,
                    transform_V1_Hx_precinct_recalc_HF_prev_c);
    SET_ONLY_C(transform_vertical_loop_hf_line_0,
                    transform_vertical_loop_hf_line_0_c);
    SET_ONLY_C(transform_vertical_loop_lf_line_0,
                    transform_vertical_loop_lf_line_0_c);
    SET_ONLY_C(transform_vertical_loop_lf_hf_line_0,
                    transform_vertical_loop_lf_hf_line_0_c);
    SET_ONLY_C(transform_vertical_loop_lf_hf_line_x_prev,
                    transform_vertical_loop_lf_hf_line_x_prev_c);
    SET_ONLY_C(transform_vertical_loop_lf_hf_hf_line_x,
                    transform_vertical_loop_lf_hf_hf_line_x_c);
    SET_ONLY_C(transform_vertical_loop_lf_hf_hf_line_last_even,
                    transform_vertical_loop_lf_hf_hf_line_last_even_c);
    SET_ONLY_C(linear_input_scaling_line_8bit,
                    linear_input_scaling_line_8bit_c);
    SET_ONLY_C(linear_input_scaling_line_16bit,
                    linear_input_scaling_line_16bit_c);
    SET_ONLY_C(pack_data_single_group, pack_data_single_group_c);
    SET_ONLY_C(rate_control_calc_vpred_cost_nosigf,
                    rate_control_calc_vpred_cost_nosigf_c);
    SET_ONLY_C(convert_packed_to_planar_rgb_8bit,
                    convert_packed_to_planar_rgb_8bit_c);
    SET_ONLY_C(convert_packed_to_planar_rgb_16bit,
                    convert_packed_to_planar_rgb_16bit_c);
    SET_ONLY_C(rate_control_calc_vpred_cost_sigf_nosigf,
               rate_control_calc_vpred_cost_sigf_nosigf_c);
#endif
