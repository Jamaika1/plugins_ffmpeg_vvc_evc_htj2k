...
#if defined(__AVX2__)
#include "ASM_AVX2/Dwt53Decoder_AVX2.h"
#endif
#include "Dequant.h"
#include "ASM_SSE4_1/Dequant_SSE4.h"
#include "Idwt.h"
#include "NltDec.h"
#if defined(__AVX2__)
#include "ASM_AVX2/NltDec_AVX2.h"
#endif
#include "Precinct.h"
#if defined(__AVX2__)
#include "ASM_AVX2/UnPack_avx2.h"
#endif
#include "Packing.h"
#if defined(__AVX512F__)
#include "ASM_AVX512/idwt-avx512.h"
#include "ASM_AVX512/NltDec_avx512.h"
#include "ASM_AVX512/Dequant_avx512.h"
#endif
...
void setup_decoder_rtcd_internal(CPU_FLAGS flags) {
    ...
    SET_AVX2(inv_sign, inv_sign_c, inv_sign_avx2);
    SET_AVX2(unpack_data, unpack_data_c, unpack_data_avx2);
    SET_SSE41_AVX2(dequant, dequant_c, dequant_sse4_1, NULL);
    SET_AVX2(linear_output_scaling_8bit_line,
                    linear_output_scaling_8bit_line_c,
                    linear_output_scaling_8bit_line_avx2);
    SET_AVX2(linear_output_scaling_16bit_line,
                    linear_output_scaling_16bit_line_c,
                    linear_output_scaling_16bit_line_avx2);

    SET_AVX2(idwt_horizontal_line_lf16_hf16,
                    idwt_horizontal_line_lf16_hf16_c,
                    idwt_horizontal_line_lf16_hf16_avx2);
    SET_AVX2(idwt_horizontal_line_lf32_hf16,
                    idwt_horizontal_line_lf32_hf16_c,
                    idwt_horizontal_line_lf32_hf16_avx2);
    SET_AVX2(idwt_vertical_line, idwt_vertical_line_c, idwt_vertical_line_avx2);
    SET_AVX2(idwt_vertical_line_recalc, idwt_vertical_line_recalc_c, idwt_vertical_line_recalc_avx2);
#else
    ...
    //SET_SSE41(dequant, dequant_c, dequant_sse4_1);
    SET_ONLY_C(dequant, dequant_c);
    SET_ONLY_C(linear_output_scaling_8bit_line,
                    linear_output_scaling_8bit_line_c);
    SET_ONLY_C(linear_output_scaling_16bit_line,
                    linear_output_scaling_16bit_line_c);

    SET_ONLY_C(idwt_horizontal_line_lf16_hf16,
                    idwt_horizontal_line_lf16_hf16_c);
    SET_ONLY_C(idwt_horizontal_line_lf32_hf16,
                    idwt_horizontal_line_lf32_hf16_c);
