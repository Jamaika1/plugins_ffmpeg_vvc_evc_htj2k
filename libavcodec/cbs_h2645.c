...
#include "extra/cbs_sei_syntax_template.c"
#undef FUNC

#define FUNC(name) FUNC_H264(name)
#include "extra/cbs_h264_syntax_template.c"
#undef FUNC

#define FUNC(name) FUNC_H265(name)
#include "extra/cbs_h265_syntax_template.c"
#undef FUNC

#define FUNC(name) FUNC_H266(name)
#include "extra/cbs_h266_syntax_template.c"
#undef FUNC
...
static const CodedBitstreamUnitTypeDescriptor cbs_h266_unit_types[] = {
    ...
    CBS_UNIT_RANGE_INTERNAL_REF(VVC_TRAIL_NUT, VVC_GDR_NUT,
                                H266RawSlice, data),
