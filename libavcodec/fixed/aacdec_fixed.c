...
#include "libavcodec/aacdec_fixed_dequant.h"

#include "libavcodec/aacdec_fixed_coupling.h"
#include "libavcodec/aacdec_fixed_prediction.h"
#include "../extra/aacdec_dsp_template.c"
#include "../extra/aacdec_proc_template.c"
