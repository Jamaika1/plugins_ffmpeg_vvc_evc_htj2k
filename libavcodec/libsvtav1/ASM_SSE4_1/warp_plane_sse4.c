...
static INLINE void svt_prepare_vertical_filter_coeffs(int gamma, int sy, __m128i *coeffs) {
    const __m128i tmp_0 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sy + 0 * gamma) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_2 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sy + 2 * gamma) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_4 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sy + 4 * gamma) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_6 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sy + 6 * gamma) >> WARPEDDIFF_PREC_BITS)));
    ...
    const __m128i tmp_1 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sy + 1 * gamma) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_3 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sy + 3 * gamma) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_5 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sy + 5 * gamma) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_7 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sy + 7 * gamma) >> WARPEDDIFF_PREC_BITS)));
...
static INLINE void svt_prepare_vertical_filter_coeffs_gamma0(int sy, __m128i *coeffs) {
    const __m128i tmp_0 = _mm_loadu_si128((__m128i *)(eb_warped_filter + (sy >> WARPEDDIFF_PREC_BITS)));
...
static INLINE void highbd_prepare_horizontal_filter_coeff_alpha0(int sx, __m128i *coeff) {
    // Filter coeff
    const __m128i tmp_0 = _mm_loadu_si128((__m128i *)(eb_warped_filter + (sx >> WARPEDDIFF_PREC_BITS)));
...
static INLINE void highbd_prepare_horizontal_filter_coeff(int alpha, int sx, __m128i *coeff) {
    // Filter even-index pixels
    const __m128i tmp_0 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sx + 0 * alpha) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_2 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sx + 2 * alpha) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_4 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sx + 4 * alpha) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_6 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sx + 6 * alpha) >> WARPEDDIFF_PREC_BITS)));
    ...
    // Filter odd-index pixels
    const __m128i tmp_1 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sx + 1 * alpha) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_3 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sx + 3 * alpha) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_5 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sx + 5 * alpha) >> WARPEDDIFF_PREC_BITS)));
    const __m128i tmp_7 = _mm_loadu_si128((__m128i *)(eb_warped_filter + ((sx + 7 * alpha) >> WARPEDDIFF_PREC_BITS)));
