...
#include "../ASM_SSSE3/av1_inv_txfm_ssse3.h"

void svt_av1_highbd_inv_txfm2d_add_universe_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r,
                                                   uint16_t *output_w, int32_t stride_w, TxType tx_type, TxSize tx_size,
                                                   int32_t eob, const int32_t bd);

typedef void (*Transform1dSse41)(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd,
                                 int32_t out_shift);
...
static void addsub_sse4_1(const __m128i in0, const __m128i in1, __m128i *out0, __m128i *out1, const __m128i *clamp_lo,
...
static void shift_and_clamp_sse4_1(__m128i *in0, __m128i *in1, const __m128i *clamp_lo, const __m128i *clamp_hi,
                                   int shift) {
...
static void idct4x4_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd, int32_t out_shift) {
    (void)*out;
    (void)bd;
    (void)out_shift;
...
static void highbd_clamp_epi32_sse4_1(const __m128i *in, __m128i *out, const __m128i *clamp_lo, const __m128i *clamp_hi,
                                      int32_t size) {
    __m128i a0, a1;
...
static void iadst4x4_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd, int32_t out_shift) {
    (void)out_shift;
...
static void write_buffer_4x4(__m128i *in, uint16_t *output_r, int32_t stride_r, uint16_t *output_w, int32_t stride_w,
...
void svt_av1_inv_txfm2d_add_4x4_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
...
static __m128i get_recon_8x8(const __m128i pred, __m128i res_lo, __m128i res_hi, int32_t fliplr, int32_t bd) {
    __m128i       x0, x1;
    const __m128i zero = _mm_setzero_si128();
...
static void write_buffer_8x8(__m128i *in, uint16_t *output_r, int32_t stride_r, uint16_t *output_w, int32_t stride_w,
                             int32_t fliplr, int32_t flipud, int32_t shift, int32_t bd) {
    __m128i u0, u1, u2, u3, u4, u5, u6, u7;
    __m128i v0, v1, v2, v3, v4, v5, v6, v7;
...
void svt_av1_inv_txfm2d_add_8x8_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
                                       int32_t stride_w, TxType tx_type, int32_t bd) {
    ...
    case V_DCT:
        ...
        // svt_av1_iidentity8_c() shift left 1 bits
        // round_shift_8x8(, -shift[0]) shift right 1 bits
        idct8x8_sse4_1(in, out, inv_cos_bit_row[txw_idx][txh_idx]);
    ...
    case V_ADST:
        ...
        // svt_av1_iidentity8_c() shift left 1 bits
        // round_shift_8x8(, -shift[0]) shift right 1 bits
        iadst8x8_sse4_1(in, out, inv_cos_bit_col[txw_idx][txh_idx]);
        write_buffer_8x8(out, output_r, stride_r, output_w, stride_w, 0, 0, -shift[1], bd);
        break;
    case H_ADST:
        load_buffer_8x8(input, in);
...
static void write_buffer_16x16(__m128i *in, uint16_t *output_r, int32_t stride_r, uint16_t *output_w, int32_t stride_w,
                               int32_t fliplr, int32_t flipud, int32_t shift, int32_t bd) {
    __m128i   in8x8[16];
...
static INLINE void iidentity16_and_round_shift_sse4_1(__m128i *input, int32_t shift) {
    ...
    const __m128i scalar = _mm_set1_epi32(new_sqrt2);
    const __m128i rnding = _mm_set1_epi32((1 << (new_sqrt2_bits - 2)) + (!!(shift) << (shift + new_sqrt2_bits - 2)));

    for (int32_t i = 0; i < 64; i++) {
        input[i] = _mm_mullo_epi32(input[i], scalar);
        input[i] = _mm_add_epi32(input[i], rnding);
        input[i] = _mm_srai_epi32(input[i], new_sqrt2_bits - 1 + shift);
    }
}

void svt_av1_inv_txfm2d_add_16x16_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
                                         int32_t stride_w, TxType tx_type, int32_t bd) {
    ...
    case IDTX:
        load_buffer_16x16(input, in);
        iidentity16_and_round_shift_sse4_1(in, -shift[0]);
        iidentity16_and_round_shift_sse4_1(in, -shift[1]);
        write_buffer_16x16(in, output_r, stride_r, output_w, stride_w, 0, 0, 0, bd);
        break;
    case V_DCT:
        load_buffer_16x16(input, in);
        iidentity16_and_round_shift_sse4_1(in, -shift[0]);
        idct16x16_sse4_1(in, out, inv_cos_bit_col[txw_idx][txh_idx]);
    ...
    case H_DCT:
        ...
        iidentity16_and_round_shift_sse4_1(out, -shift[1]);
        write_buffer_16x16(out, output_r, stride_r, output_w, stride_w, 0, 0, 0, bd);
        break;
    case V_ADST:
        load_buffer_16x16(input, in);
        iidentity16_and_round_shift_sse4_1(in, -shift[0]);
        iadst16x16_sse4_1(in, out, inv_cos_bit_col[txw_idx][txh_idx]);
        write_buffer_16x16(out, output_r, stride_r, output_w, stride_w, 0, 0, -shift[1], bd);
        break;
    case H_ADST:
        load_buffer_16x16(input, in);
...
static void write_buffer_32x32(__m128i *in, uint16_t *output_r, int32_t stride_r, uint16_t *output_w, int32_t stride_w,
                               int32_t fliplr, int32_t flipud, int32_t shift, int32_t bd) {
...
static void write_buffer_64x64(__m128i *in, uint16_t *output_r, int32_t stride_r, uint16_t *output_w, int32_t stride_w,
                               int32_t fliplr, int32_t flipud, int32_t shift, int32_t bd) {
...
static void idct64x64_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd) {
    ...
    for (col = 0; col < (do_cols ? 64 / 4 : 32 / 4); ++col) {
        ...
        // stage 8
        for (i = 0; i < 4; ++i) addsub_sse4_1(u[i], u[7 - i], &v[i], &v[7 - i], &clamp_lo, &clamp_hi);
        v[8]  = u[8];
        v[9]  = u[9];
        v[14] = u[14];
        v[15] = u[15];
        ...
        // stage 9
        for (i = 0; i < 8; ++i) addsub_sse4_1(v[i], v[15 - i], &u[i], &u[15 - i], &clamp_lo, &clamp_hi);
        for (i = 16; i < 20; ++i) {
            u[i]      = v[i];
            u[i + 12] = v[i + 12];
        }
        ...
        for (i = 32; i < 40; i++) addsub_sse4_1(v[i], v[i ^ 15], &u[i], &u[i ^ 15], &clamp_lo, &clamp_hi);
        for (i = 48; i < 56; i++) addsub_sse4_1(v[i ^ 15], v[i], &u[i ^ 15], &u[i], &clamp_lo, &clamp_hi);
        // stage 10
        for (i = 0; i < 16; i++) addsub_sse4_1(u[i], u[31 - i], &v[i], &v[31 - i], &clamp_lo, &clamp_hi);
        ...
        // stage 11
        for (i = 0; i < 32; i++) {
            addsub_sse4_1(v[i], v[63 - i], &out[16 * (i) + col], &out[16 * (63 - i) + col], &clamp_lo, &clamp_hi);
        }
    }
}

void svt_av1_inv_txfm2d_add_64x64_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
                                         int32_t stride_w, TxType tx_type, int32_t bd) {
...
//4x8
static INLINE void load_buffer_32bit_input(const int32_t *in, int32_t stride, __m128i *out, int32_t out_size) {
    for (int32_t i = 0; i < out_size; ++i) out[i] = _mm_loadu_si128((const __m128i *)(in + i * stride));
}
...
static void iidentity4_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd, int32_t out_shift) {
    (void)bit;
    __m128i v[4];
...
static void iidentity8_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd, int32_t out_shift) {
    (void)bit;
...
static void iidentity16_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd, int32_t out_shift) {
    (void)bit;
...
static INLINE __m128i highbd_get_recon_4xn_sse4_1(const __m128i pred, __m128i res0, const int32_t bd) {
...
static void idct8x8_new_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd, int32_t out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi56   = _mm_set1_epi32(cospi[56]);
    const __m128i  cospim8   = _mm_set1_epi32(-cospi[8]);
    const __m128i  cospi24   = _mm_set1_epi32(cospi[24]);
...
static void iadst8x8_low1_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd,
                                 int32_t out_shift) {
    const int32_t *cospi   = cospi_arr(bit);
    const __m128i  cospi4  = _mm_set1_epi32(cospi[4]);
    const __m128i  cospi60 = _mm_set1_epi32(cospi[60]);
...
static void idct16x16_low1_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd,
                                  int32_t out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi32   = _mm_set1_epi32(cospi[32]);
    const __m128i  rnding    = _mm_set1_epi32(1 << (bit - 1));
...
static void idct16x16_low8_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd,
                                  int32_t out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi60   = _mm_set1_epi32(cospi[60]);
    const __m128i  cospi28   = _mm_set1_epi32(cospi[28]);
...
static void idct16x16_new_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd,
                                 int32_t out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi60   = _mm_set1_epi32(cospi[60]);
    const __m128i  cospim4   = _mm_set1_epi32(-cospi[4]);
...
static void iadst16x16_new_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd,
                                  int32_t out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi2    = _mm_set1_epi32(cospi[2]);
    const __m128i  cospi62   = _mm_set1_epi32(cospi[62]);
    ...
    // Calculate the column 0, 1, 2, 3
    {
        ...
        if (do_cols) {
            ...
            neg_shift_sse4_1(v[12], v[4], out + 2, out + 3, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(v[6], v[14], out + 4, out + 5, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(v[10], v[2], out + 6, out + 7, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(v[3], v[11], out + 8, out + 9, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(v[15], v[7], out + 10, out + 11, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(v[5], v[13], out + 12, out + 13, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(v[9], v[1], out + 14, out + 15, &clamp_lo_out, &clamp_hi_out, out_shift);
        }
    }
}

static void iadst16x16_low1_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd,
                                   int32_t out_shift) {
    const int32_t *cospi   = cospi_arr(bit);
    const __m128i  cospi2  = _mm_set1_epi32(cospi[2]);
    const __m128i  cospi62 = _mm_set1_epi32(cospi[62]);
...
static void iadst16x16_low8_sse4_1(__m128i *in, __m128i *out, int32_t bit, int32_t do_cols, int32_t bd,
                                   int32_t out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi2    = _mm_set1_epi32(cospi[2]);
    const __m128i  cospi62   = _mm_set1_epi32(cospi[62]);
    ...
    // Calculate the column 0, 1, 2, 3
    {
        ...
        if (do_cols) {
            ...
            neg_shift_sse4_1(u[12], u[4], out + 2, out + 3, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(u[6], u[14], out + 4, out + 5, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(u[10], u[2], out + 6, out + 7, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(u[3], u[11], out + 8, out + 9, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(u[15], u[7], out + 10, out + 11, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(u[5], u[13], out + 12, out + 13, &clamp_lo_out, &clamp_hi_out, out_shift);
            neg_shift_sse4_1(u[9], u[1], out + 14, out + 15, &clamp_lo_out, &clamp_hi_out, out_shift);
        }
    }
}

static INLINE void highbd_write_buffer_4xn_sse4_1(__m128i *in, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
...
static INLINE void idct32_stage4_sse4_1(__m128i *bf1, const __m128i *cospim8, const __m128i *cospi56,
    ...
    bf1[29] = half_btf_sse4_1(cospim8, &bf1[18], cospi56, &bf1[29], rounding, bit);
    bf1[18] = temp2;

    temp1   = half_btf_sse4_1(cospim40, &bf1[21], cospi24, &bf1[26], rounding, bit);
    bf1[26] = half_btf_sse4_1(cospi24, &bf1[21], cospi40, &bf1[26], rounding, bit);
    bf1[21] = temp1;

    temp2   = half_btf_sse4_1(cospim24, &bf1[22], cospim40, &bf1[25], rounding, bit);
    bf1[25] = half_btf_sse4_1(cospim40, &bf1[22], cospi24, &bf1[25], rounding, bit);
    bf1[22] = temp2;
}

static INLINE void idct32_stage5_sse4_1(__m128i *bf1, const __m128i *cospim16, const __m128i *cospi48,
    ...
    temp2   = half_btf_sse4_1(cospim48, &bf1[10], cospim16, &bf1[13], rounding, bit);
    bf1[13] = half_btf_sse4_1(cospim16, &bf1[10], cospi48, &bf1[13], rounding, bit);
    bf1[10] = temp2;
...
static INLINE void idct32_stage6_sse4_1(__m128i *bf1, const __m128i *cospim32, const __m128i *cospi32,
    ...
    bf1[29] = half_btf_sse4_1(cospi48, &bf1[18], cospi16, &bf1[29], rounding, bit);
    bf1[18] = temp1;
    temp2   = half_btf_sse4_1(cospim16, &bf1[19], cospi48, &bf1[28], rounding, bit);
    bf1[28] = half_btf_sse4_1(cospi48, &bf1[19], cospi16, &bf1[28], rounding, bit);
    bf1[19] = temp2;
    temp1   = half_btf_sse4_1(cospim48, &bf1[20], cospim16, &bf1[27], rounding, bit);
    bf1[27] = half_btf_sse4_1(cospim16, &bf1[20], cospi48, &bf1[27], rounding, bit);
    bf1[20] = temp1;
    temp2   = half_btf_sse4_1(cospim48, &bf1[21], cospim16, &bf1[26], rounding, bit);
    bf1[26] = half_btf_sse4_1(cospim16, &bf1[21], cospi48, &bf1[26], rounding, bit);
    bf1[21] = temp2;
}

static INLINE void idct32_stage7_sse4_1(__m128i *bf1, const __m128i *cospim32, const __m128i *cospi32,
                                        const __m128i *clamp_lo, const __m128i *clamp_hi, const __m128i *rounding,
                                        int bit) {
    __m128i temp1, temp2;
    ...
    bf1[13] = half_btf_sse4_1(cospi32, &bf1[10], cospi32, &bf1[13], rounding, bit);
    bf1[10] = temp1;
    temp2   = half_btf_sse4_1(cospim32, &bf1[11], cospi32, &bf1[12], rounding, bit);
    bf1[12] = half_btf_sse4_1(cospi32, &bf1[11], cospi32, &bf1[12], rounding, bit);
    bf1[11] = temp2;
...
static INLINE void idct32_stage8_sse4_1(__m128i *bf1, const __m128i *cospim32, const __m128i *cospi32,
                                        const __m128i *clamp_lo, const __m128i *clamp_hi, const __m128i *rounding,
                                        int bit) {
    __m128i temp1, temp2;
    ...
    bf1[27] = half_btf_sse4_1(cospi32, &bf1[20], cospi32, &bf1[27], rounding, bit);
    bf1[20] = temp1;
    temp2   = half_btf_sse4_1(cospim32, &bf1[21], cospi32, &bf1[26], rounding, bit);
    bf1[26] = half_btf_sse4_1(cospi32, &bf1[21], cospi32, &bf1[26], rounding, bit);
    bf1[21] = temp2;
    temp1   = half_btf_sse4_1(cospim32, &bf1[22], cospi32, &bf1[25], rounding, bit);
    bf1[25] = half_btf_sse4_1(cospi32, &bf1[22], cospi32, &bf1[25], rounding, bit);
    bf1[22] = temp1;
    temp2   = half_btf_sse4_1(cospim32, &bf1[23], cospi32, &bf1[24], rounding, bit);
    bf1[24] = half_btf_sse4_1(cospi32, &bf1[23], cospi32, &bf1[24], rounding, bit);
    bf1[23] = temp2;
}

static INLINE void idct32_stage9_sse4_1(__m128i *bf1, __m128i *out, const int do_cols, const int bd,
                                        const int out_shift, const __m128i *clamp_lo, const __m128i *clamp_hi) {
...
static INLINE void idct64_stage8_sse4_1(__m128i *u, const __m128i *cospim32, const __m128i *cospi32,
                                        const __m128i *cospim16, const __m128i *cospi48, const __m128i *cospi16,
                                        const __m128i *cospim48, const __m128i *clamp_lo, const __m128i *clamp_hi,
    ...
    for (i = 16; i < 20; ++i) {
        ...
        addsub_sse4_1(u[i ^ 15], u[i ^ 8], &u[i ^ 15], &u[i ^ 8], clamp_lo, clamp_hi);
    }
...
static INLINE void idct64_stage9_sse4_1(__m128i *u, const __m128i *cospim32, const __m128i *cospi32,
                                        const __m128i *clamp_lo, const __m128i *clamp_hi, const __m128i *rnding,
                                        int bit) {
    int     i;
    __m128i temp1, temp2, temp3, temp4;
    for (i = 0; i < 8; ++i) { addsub_sse4_1(u[i], u[15 - i], &u[i], &u[15 - i], clamp_lo, clamp_hi); }
    ...
    u[22] = temp3;
    u[23] = temp4;
    for (i = 32; i < 40; i++) { addsub_sse4_1(u[i], u[i ^ 15], &u[i], &u[i ^ 15], clamp_lo, clamp_hi); }

    for (i = 48; i < 56; i++) { addsub_sse4_1(u[i ^ 15], u[i], &u[i ^ 15], &u[i], clamp_lo, clamp_hi); }
}

static INLINE void idct64_stage10_sse4_1(__m128i *u, const __m128i *cospim32, const __m128i *cospi32,
                                         const __m128i *clamp_lo, const __m128i *clamp_hi, const __m128i *rnding,
                                         int bit) {
    __m128i temp1, temp2, temp3, temp4;
    for (int i = 0; i < 16; i++) { addsub_sse4_1(u[i], u[31 - i], &u[i], &u[31 - i], clamp_lo, clamp_hi); }
...
static INLINE void idct64_stage11_sse4_1(__m128i *u, __m128i *out, int do_cols, int bd, int out_shift,
                                         const __m128i *clamp_lo, const __m128i *clamp_hi) {
    for (int i = 0; i < 32; i++) { addsub_sse4_1(u[i], u[63 - i], out + i, out + 63 - i, clamp_lo, clamp_hi); }
    ...
    if (!do_cols) {
        ...
        for (int i = 0; i < 64; i += 4) {
            round_shift_4x4(out + i, out_shift);
            highbd_clamp_epi32_sse4_1(out + i, out + i, &clamp_lo_out, &clamp_hi_out, 4);
        }
    }
}

static void idct32x32_low1_sse4_1(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi32   = _mm_set1_epi32(cospi[32]);
...
static void idct32x32_low8_sse4_1(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi62   = _mm_set1_epi32(cospi[62]);
    const __m128i  cospi14   = _mm_set1_epi32(cospi[14]);
    const __m128i  cospi54   = _mm_set1_epi32(cospi[54]);
    ...
    idct32_stage5_sse4_1(bf1, &cospim16, &cospi48, &cospi16, &cospim48, &clamp_lo, &clamp_hi, &rounding, bit);
    ...
    // stage 7
    idct32_stage7_sse4_1(bf1, &cospim32, &cospi32, &clamp_lo, &clamp_hi, &rounding, bit);

    // stage 8
    idct32_stage8_sse4_1(bf1, &cospim32, &cospi32, &clamp_lo, &clamp_hi, &rounding, bit);

    // stage 9
    idct32_stage9_sse4_1(bf1, out, do_cols, bd, out_shift, &clamp_lo, &clamp_hi);
}

static void idct32x32_low16_sse4_1(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi62   = _mm_set1_epi32(cospi[62]);
    const __m128i  cospi30   = _mm_set1_epi32(cospi[30]);
    const __m128i  cospi46   = _mm_set1_epi32(cospi[46]);
...
static void idct32x32_sse4_1(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  cospi62   = _mm_set1_epi32(cospi[62]);
    const __m128i  cospi30   = _mm_set1_epi32(cospi[30]);
    const __m128i  cospi46   = _mm_set1_epi32(cospi[46]);
    ...
    bf0[14] = bf1[14];
    bf0[15] = bf1[15];
    bf0[16] = half_btf_sse4_1(&cospi62, &bf1[16], &cospim2, &bf1[31], &rounding, bit);
    bf0[17] = half_btf_sse4_1(&cospi30, &bf1[17], &cospim34, &bf1[30], &rounding, bit);
    bf0[18] = half_btf_sse4_1(&cospi46, &bf1[18], &cospim18, &bf1[29], &rounding, bit);
    bf0[19] = half_btf_sse4_1(&cospi14, &bf1[19], &cospim50, &bf1[28], &rounding, bit);
    bf0[20] = half_btf_sse4_1(&cospi54, &bf1[20], &cospim10, &bf1[27], &rounding, bit);
    bf0[21] = half_btf_sse4_1(&cospi22, &bf1[21], &cospim42, &bf1[26], &rounding, bit);
    bf0[22] = half_btf_sse4_1(&cospi38, &bf1[22], &cospim26, &bf1[25], &rounding, bit);
    bf0[23] = half_btf_sse4_1(&cospi6, &bf1[23], &cospim58, &bf1[24], &rounding, bit);
    bf0[24] = half_btf_sse4_1(&cospi58, &bf1[23], &cospi6, &bf1[24], &rounding, bit);
    bf0[25] = half_btf_sse4_1(&cospi26, &bf1[22], &cospi38, &bf1[25], &rounding, bit);
    bf0[26] = half_btf_sse4_1(&cospi42, &bf1[21], &cospi22, &bf1[26], &rounding, bit);
    bf0[27] = half_btf_sse4_1(&cospi10, &bf1[20], &cospi54, &bf1[27], &rounding, bit);
    bf0[28] = half_btf_sse4_1(&cospi50, &bf1[19], &cospi14, &bf1[28], &rounding, bit);
    bf0[29] = half_btf_sse4_1(&cospi18, &bf1[18], &cospi46, &bf1[29], &rounding, bit);
    bf0[30] = half_btf_sse4_1(&cospi34, &bf1[17], &cospi30, &bf1[30], &rounding, bit);
    bf0[31] = half_btf_sse4_1(&cospi2, &bf1[16], &cospi62, &bf1[31], &rounding, bit);
    ...
    bf1[6]  = bf0[6];
    bf1[7]  = bf0[7];
    bf1[8]  = half_btf_sse4_1(&cospi60, &bf0[8], &cospim4, &bf0[15], &rounding, bit);
    bf1[9]  = half_btf_sse4_1(&cospi28, &bf0[9], &cospim36, &bf0[14], &rounding, bit);
    bf1[10] = half_btf_sse4_1(&cospi44, &bf0[10], &cospim20, &bf0[13], &rounding, bit);
    bf1[11] = half_btf_sse4_1(&cospi12, &bf0[11], &cospim52, &bf0[12], &rounding, bit);
    bf1[12] = half_btf_sse4_1(&cospi52, &bf0[11], &cospi12, &bf0[12], &rounding, bit);
    bf1[13] = half_btf_sse4_1(&cospi20, &bf0[10], &cospi44, &bf0[13], &rounding, bit);
    bf1[14] = half_btf_sse4_1(&cospi36, &bf0[9], &cospi28, &bf0[14], &rounding, bit);
    bf1[15] = half_btf_sse4_1(&cospi4, &bf0[8], &cospi60, &bf0[15], &rounding, bit);
    ...
    bf0[2] = bf1[2];
    bf0[3] = bf1[3];
    bf0[4] = half_btf_sse4_1(&cospi56, &bf1[4], &cospim8, &bf1[7], &rounding, bit);
    bf0[5] = half_btf_sse4_1(&cospi24, &bf1[5], &cospim40, &bf1[6], &rounding, bit);
    bf0[6] = half_btf_sse4_1(&cospi40, &bf1[5], &cospi24, &bf1[6], &rounding, bit);
    ...
    bf0[16] = bf1[16];
    bf0[17] = half_btf_sse4_1(&cospim8, &bf1[17], &cospi56, &bf1[30], &rounding, bit);
    bf0[18] = half_btf_sse4_1(&cospim56, &bf1[18], &cospim8, &bf1[29], &rounding, bit);
    bf0[19] = bf1[19];
    bf0[20] = bf1[20];
    bf0[21] = half_btf_sse4_1(&cospim40, &bf1[21], &cospi24, &bf1[26], &rounding, bit);
    bf0[22] = half_btf_sse4_1(&cospim24, &bf1[22], &cospim40, &bf1[25], &rounding, bit);
    bf0[23] = bf1[23];
    bf0[24] = bf1[24];
    bf0[25] = half_btf_sse4_1(&cospim40, &bf1[22], &cospi24, &bf1[25], &rounding, bit);
    bf0[26] = half_btf_sse4_1(&cospi24, &bf1[21], &cospi40, &bf1[26], &rounding, bit);
    bf0[27] = bf1[27];
    bf0[28] = bf1[28];
    bf0[29] = half_btf_sse4_1(&cospim8, &bf1[18], &cospi56, &bf1[29], &rounding, bit);
    bf0[30] = half_btf_sse4_1(&cospi56, &bf1[17], &cospi8, &bf1[30], &rounding, bit);
    bf0[31] = bf1[31];

    // stage 5
    bf1[0] = half_btf_sse4_1(&cospi32, &bf0[0], &cospi32, &bf0[1], &rounding, bit);
    bf1[1] = half_btf_sse4_1(&cospi32, &bf0[0], &cospim32, &bf0[1], &rounding, bit);
    bf1[2] = half_btf_sse4_1(&cospi48, &bf0[2], &cospim16, &bf0[3], &rounding, bit);
    bf1[3] = half_btf_sse4_1(&cospi16, &bf0[2], &cospi48, &bf0[3], &rounding, bit);
    addsub_sse4_1(bf0[4], bf0[5], bf1 + 4, bf1 + 5, &clamp_lo, &clamp_hi);
    addsub_sse4_1(bf0[7], bf0[6], bf1 + 7, bf1 + 6, &clamp_lo, &clamp_hi);
    bf1[8]  = bf0[8];
    bf1[9]  = half_btf_sse4_1(&cospim16, &bf0[9], &cospi48, &bf0[14], &rounding, bit);
    bf1[10] = half_btf_sse4_1(&cospim48, &bf0[10], &cospim16, &bf0[13], &rounding, bit);
    bf1[11] = bf0[11];
    bf1[12] = bf0[12];
    bf1[13] = half_btf_sse4_1(&cospim16, &bf0[10], &cospi48, &bf0[13], &rounding, bit);
    bf1[14] = half_btf_sse4_1(&cospi48, &bf0[9], &cospi16, &bf0[14], &rounding, bit);
    bf1[15] = bf0[15];
    ...
    bf0[4] = bf1[4];
    bf0[5] = half_btf_sse4_1(&cospim32, &bf1[5], &cospi32, &bf1[6], &rounding, bit);
    bf0[6] = half_btf_sse4_1(&cospi32, &bf1[5], &cospi32, &bf1[6], &rounding, bit);
    bf0[7] = bf1[7];
    ...
    bf0[16] = bf1[16];
    bf0[17] = bf1[17];
    bf0[18] = half_btf_sse4_1(&cospim16, &bf1[18], &cospi48, &bf1[29], &rounding, bit);
    bf0[19] = half_btf_sse4_1(&cospim16, &bf1[19], &cospi48, &bf1[28], &rounding, bit);
    bf0[20] = half_btf_sse4_1(&cospim48, &bf1[20], &cospim16, &bf1[27], &rounding, bit);
    bf0[21] = half_btf_sse4_1(&cospim48, &bf1[21], &cospim16, &bf1[26], &rounding, bit);
    bf0[22] = bf1[22];
    bf0[23] = bf1[23];
    bf0[24] = bf1[24];
    bf0[25] = bf1[25];
    bf0[26] = half_btf_sse4_1(&cospim16, &bf1[21], &cospi48, &bf1[26], &rounding, bit);
    bf0[27] = half_btf_sse4_1(&cospim16, &bf1[20], &cospi48, &bf1[27], &rounding, bit);
    bf0[28] = half_btf_sse4_1(&cospi48, &bf1[19], &cospi16, &bf1[28], &rounding, bit);
    bf0[29] = half_btf_sse4_1(&cospi48, &bf1[18], &cospi16, &bf1[29], &rounding, bit);
    bf0[30] = bf1[30];
    bf0[31] = bf1[31];
    ...
    bf1[8]  = bf0[8];
    bf1[9]  = bf0[9];
    bf1[10] = half_btf_sse4_1(&cospim32, &bf0[10], &cospi32, &bf0[13], &rounding, bit);
    bf1[11] = half_btf_sse4_1(&cospim32, &bf0[11], &cospi32, &bf0[12], &rounding, bit);
    bf1[12] = half_btf_sse4_1(&cospi32, &bf0[11], &cospi32, &bf0[12], &rounding, bit);
    bf1[13] = half_btf_sse4_1(&cospi32, &bf0[10], &cospi32, &bf0[13], &rounding, bit);
    bf1[14] = bf0[14];
    bf1[15] = bf0[15];
    ...
    bf0[18] = bf1[18];
    bf0[19] = bf1[19];
    bf0[20] = half_btf_sse4_1(&cospim32, &bf1[20], &cospi32, &bf1[27], &rounding, bit);
    bf0[21] = half_btf_sse4_1(&cospim32, &bf1[21], &cospi32, &bf1[26], &rounding, bit);
    bf0[22] = half_btf_sse4_1(&cospim32, &bf1[22], &cospi32, &bf1[25], &rounding, bit);
    bf0[23] = half_btf_sse4_1(&cospim32, &bf1[23], &cospi32, &bf1[24], &rounding, bit);
    bf0[24] = half_btf_sse4_1(&cospi32, &bf1[23], &cospi32, &bf1[24], &rounding, bit);
    bf0[25] = half_btf_sse4_1(&cospi32, &bf1[22], &cospi32, &bf1[25], &rounding, bit);
    bf0[26] = half_btf_sse4_1(&cospi32, &bf1[21], &cospi32, &bf1[26], &rounding, bit);
    bf0[27] = half_btf_sse4_1(&cospi32, &bf1[20], &cospi32, &bf1[27], &rounding, bit);
    bf0[28] = bf1[28];
    bf0[29] = bf1[29];
    bf0[30] = bf1[30];
    bf0[31] = bf1[31];
...
static void iidentity32_sse4_1(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift) {
    (void)bit;
...
static void idct64x64_low1_sse4_1(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  rnding    = _mm_set1_epi32(1 << (bit - 1));
    const int      log_range = AOMMAX(16, bd + (do_cols ? 6 : 8));
    __m128i        clamp_lo  = _mm_set1_epi32(-(1 << (log_range - 1)));
...
static void idct64x64_low8_sse4_1(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  rnding    = _mm_set1_epi32(1 << (bit - 1));
    const int      log_range = AOMMAX(16, bd + (do_cols ? 6 : 8));
    const __m128i  clamp_lo  = _mm_set1_epi32(-(1 << (log_range - 1)));
...

    {
        ...
        for (int i = 32; i < 64; i += 16) {
            for (int j = i; j < i + 4; j++) {
                ...
                addsub_sse4_1(u[j ^ 15], u[j ^ 8], &u[j ^ 15], &u[j ^ 8], &clamp_lo, &clamp_hi);
            }
        }
        ...
        // stage 9
        idct64_stage9_sse4_1(u, &cospim32, &cospi32, &clamp_lo, &clamp_hi, &rnding, bit);

        // stage 10
        idct64_stage10_sse4_1(u, &cospim32, &cospi32, &clamp_lo, &clamp_hi, &rnding, bit);
...
static void idct64x64_low16_sse4_1(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  rnding    = _mm_set1_epi32(1 << (bit - 1));
    const int      log_range = AOMMAX(16, bd + (do_cols ? 6 : 8));
    const __m128i  clamp_lo  = _mm_set1_epi32(-(1 << (log_range - 1)));
...

    {
        ...
        for (int i = 32; i < 64; i += 8) {
            addsub_sse4_1(u[i + 0], u[i + 3], &u[i + 0], &u[i + 3], &clamp_lo, &clamp_hi);
            addsub_sse4_1(u[i + 1], u[i + 2], &u[i + 1], &u[i + 2], &clamp_lo, &clamp_hi);

            addsub_sse4_1(u[i + 7], u[i + 4], &u[i + 7], &u[i + 4], &clamp_lo, &clamp_hi);
            addsub_sse4_1(u[i + 6], u[i + 5], &u[i + 6], &u[i + 5], &clamp_lo, &clamp_hi);
        }
        ...
        // stage 8
        for (int i = 0; i < 4; ++i) { addsub_sse4_1(u[i], u[7 - i], &u[i], &u[7 - i], &clamp_lo, &clamp_hi); }
...
static void idct64x64_general_sse4_1(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift) {
    const int32_t *cospi     = cospi_arr(bit);
    const __m128i  rnding    = _mm_set1_epi32(1 << (bit - 1));
    const int      log_range = AOMMAX(16, bd + (do_cols ? 6 : 8));
    const __m128i  clamp_lo  = _mm_set1_epi32(-(1 << (log_range - 1)));
...

    {
        ...
        // stage 8
        for (int i = 0; i < 4; ++i) { addsub_sse4_1(u[i], u[7 - i], &v[i], &v[7 - i], &clamp_lo, &clamp_hi); }
        ...
        // stage 9
        for (int i = 0; i < 8; ++i) { addsub_sse4_1(v[i], v[15 - i], &u[i], &u[15 - i], &clamp_lo, &clamp_hi); }
        ...
        for (int i = 32; i < 40; i++) { addsub_sse4_1(v[i], v[i ^ 15], &u[i], &u[i ^ 15], &clamp_lo, &clamp_hi); }

        for (int i = 48; i < 56; i++) { addsub_sse4_1(v[i ^ 15], v[i], &u[i ^ 15], &u[i], &clamp_lo, &clamp_hi); }

        // stage 10
        for (int i = 0; i < 16; i++) { addsub_sse4_1(u[i], u[31 - i], &v[i], &v[31 - i], &clamp_lo, &clamp_hi); }

        for (int i = 32; i < 40; i++) v[i] = u[i];
        ...
        for (int i = 56; i < 64; i++) v[i] = u[i];

        // stage 11
        for (int i = 0; i < 32; i++) {
            addsub_sse4_1(v[i], v[63 - i], &out[(i)], &out[(63 - i)], &clamp_lo, &clamp_hi);
        }
...
static void idct32_sse4_1(__m128i *in, __m128i *out, int32_t bit) {
    const int32_t *cospi    = cospi_arr(bit);
    const __m128i  cospi62  = _mm_set1_epi32(cospi[62]);
    const __m128i  cospi30  = _mm_set1_epi32(cospi[30]);
    const __m128i  cospi46  = _mm_set1_epi32(cospi[46]);
    ...
    for (col = 0; col < 8; ++col) {
        ...
        bf1[14] = half_btf_sse4_1(&cospi36, &bf0[9], &cospi28, &bf0[14], &rounding, bit);
        bf1[15] = half_btf_sse4_1(&cospi4, &bf0[8], &cospi60, &bf0[15], &rounding, bit);
        bf1[16] = _mm_add_epi32(bf0[16], bf0[17]);
        bf1[17] = _mm_sub_epi32(bf0[16], bf0[17]);
        bf1[18] = _mm_sub_epi32(bf0[19], bf0[18]);
        bf1[19] = _mm_add_epi32(bf0[18], bf0[19]);
        bf1[20] = _mm_add_epi32(bf0[20], bf0[21]);
        bf1[21] = _mm_sub_epi32(bf0[20], bf0[21]);
        bf1[22] = _mm_sub_epi32(bf0[23], bf0[22]);
        bf1[23] = _mm_add_epi32(bf0[22], bf0[23]);
        bf1[24] = _mm_add_epi32(bf0[24], bf0[25]);
        bf1[25] = _mm_sub_epi32(bf0[24], bf0[25]);
        bf1[26] = _mm_sub_epi32(bf0[27], bf0[26]);
        bf1[27] = _mm_add_epi32(bf0[26], bf0[27]);
        bf1[28] = _mm_add_epi32(bf0[28], bf0[29]);
        bf1[29] = _mm_sub_epi32(bf0[28], bf0[29]);
        bf1[30] = _mm_sub_epi32(bf0[31], bf0[30]);
        bf1[31] = _mm_add_epi32(bf0[30], bf0[31]);
        ...
        bf0[6]  = half_btf_sse4_1(&cospi40, &bf1[5], &cospi24, &bf1[6], &rounding, bit);
        bf0[7]  = half_btf_sse4_1(&cospi8, &bf1[4], &cospi56, &bf1[7], &rounding, bit);
        bf0[8]  = _mm_add_epi32(bf1[8], bf1[9]);
        bf0[9]  = _mm_sub_epi32(bf1[8], bf1[9]);
        bf0[10] = _mm_sub_epi32(bf1[11], bf1[10]);
        bf0[11] = _mm_add_epi32(bf1[10], bf1[11]);
        bf0[12] = _mm_add_epi32(bf1[12], bf1[13]);
        bf0[13] = _mm_sub_epi32(bf1[12], bf1[13]);
        bf0[14] = _mm_sub_epi32(bf1[15], bf1[14]);
        bf0[15] = _mm_add_epi32(bf1[14], bf1[15]);
        bf0[16] = bf1[16];
        bf0[17] = half_btf_sse4_1(&cospim8, &bf1[17], &cospi56, &bf1[30], &rounding, bit);
        bf0[18] = half_btf_sse4_1(&cospim56, &bf1[18], &cospim8, &bf1[29], &rounding, bit);
        bf0[19] = bf1[19];
        ...
        bf1[2]  = half_btf_sse4_1(&cospi48, &bf0[2], &cospim16, &bf0[3], &rounding, bit);
        bf1[3]  = half_btf_sse4_1(&cospi16, &bf0[2], &cospi48, &bf0[3], &rounding, bit);
        bf1[4]  = _mm_add_epi32(bf0[4], bf0[5]);
        bf1[5]  = _mm_sub_epi32(bf0[4], bf0[5]);
        bf1[6]  = _mm_sub_epi32(bf0[7], bf0[6]);
        bf1[7]  = _mm_add_epi32(bf0[6], bf0[7]);
        bf1[8]  = bf0[8];
        bf1[9]  = half_btf_sse4_1(&cospim16, &bf0[9], &cospi48, &bf0[14], &rounding, bit);
        bf1[10] = half_btf_sse4_1(&cospim48, &bf0[10], &cospim16, &bf0[13], &rounding, bit);
        bf1[11] = bf0[11];
        ...
        bf1[14] = half_btf_sse4_1(&cospi48, &bf0[9], &cospi16, &bf0[14], &rounding, bit);
        bf1[15] = bf0[15];
        bf1[16] = _mm_add_epi32(bf0[16], bf0[19]);
        bf1[17] = _mm_add_epi32(bf0[17], bf0[18]);
        bf1[18] = _mm_sub_epi32(bf0[17], bf0[18]);
        bf1[19] = _mm_sub_epi32(bf0[16], bf0[19]);
        bf1[20] = _mm_sub_epi32(bf0[23], bf0[20]);
        bf1[21] = _mm_sub_epi32(bf0[22], bf0[21]);
        bf1[22] = _mm_add_epi32(bf0[21], bf0[22]);
        bf1[23] = _mm_add_epi32(bf0[20], bf0[23]);
        bf1[24] = _mm_add_epi32(bf0[24], bf0[27]);
        bf1[25] = _mm_add_epi32(bf0[25], bf0[26]);
        bf1[26] = _mm_sub_epi32(bf0[25], bf0[26]);
        bf1[27] = _mm_sub_epi32(bf0[24], bf0[27]);
        bf1[28] = _mm_sub_epi32(bf0[31], bf0[28]);
        bf1[29] = _mm_sub_epi32(bf0[30], bf0[29]);
        bf1[30] = _mm_add_epi32(bf0[29], bf0[30]);
        bf1[31] = _mm_add_epi32(bf0[28], bf0[31]);

        // stage 6
        bf0[0]  = _mm_add_epi32(bf1[0], bf1[3]);
        bf0[1]  = _mm_add_epi32(bf1[1], bf1[2]);
        bf0[2]  = _mm_sub_epi32(bf1[1], bf1[2]);
        bf0[3]  = _mm_sub_epi32(bf1[0], bf1[3]);
        bf0[4]  = bf1[4];
        bf0[5]  = half_btf_sse4_1(&cospim32, &bf1[5], &cospi32, &bf1[6], &rounding, bit);
        bf0[6]  = half_btf_sse4_1(&cospi32, &bf1[5], &cospi32, &bf1[6], &rounding, bit);
        bf0[7]  = bf1[7];
        bf0[8]  = _mm_add_epi32(bf1[8], bf1[11]);
        bf0[9]  = _mm_add_epi32(bf1[9], bf1[10]);
        bf0[10] = _mm_sub_epi32(bf1[9], bf1[10]);
        bf0[11] = _mm_sub_epi32(bf1[8], bf1[11]);
        bf0[12] = _mm_sub_epi32(bf1[15], bf1[12]);
        bf0[13] = _mm_sub_epi32(bf1[14], bf1[13]);
        bf0[14] = _mm_add_epi32(bf1[13], bf1[14]);
        bf0[15] = _mm_add_epi32(bf1[12], bf1[15]);
        bf0[16] = bf1[16];
        bf0[17] = bf1[17];
        bf0[18] = half_btf_sse4_1(&cospim16, &bf1[18], &cospi48, &bf1[29], &rounding, bit);
        bf0[19] = half_btf_sse4_1(&cospim16, &bf1[19], &cospi48, &bf1[28], &rounding, bit);
        ...
        // stage 7
        bf1[0]  = _mm_add_epi32(bf0[0], bf0[7]);
        bf1[1]  = _mm_add_epi32(bf0[1], bf0[6]);
        bf1[2]  = _mm_add_epi32(bf0[2], bf0[5]);
        bf1[3]  = _mm_add_epi32(bf0[3], bf0[4]);
        bf1[4]  = _mm_sub_epi32(bf0[3], bf0[4]);
        bf1[5]  = _mm_sub_epi32(bf0[2], bf0[5]);
        bf1[6]  = _mm_sub_epi32(bf0[1], bf0[6]);
        bf1[7]  = _mm_sub_epi32(bf0[0], bf0[7]);
        bf1[8]  = bf0[8];
        bf1[9]  = bf0[9];
        bf1[10] = half_btf_sse4_1(&cospim32, &bf0[10], &cospi32, &bf0[13], &rounding, bit);
        bf1[11] = half_btf_sse4_1(&cospim32, &bf0[11], &cospi32, &bf0[12], &rounding, bit);
        ...
        bf1[14] = bf0[14];
        bf1[15] = bf0[15];
        bf1[16] = _mm_add_epi32(bf0[16], bf0[23]);
        bf1[17] = _mm_add_epi32(bf0[17], bf0[22]);
        bf1[18] = _mm_add_epi32(bf0[18], bf0[21]);
        bf1[19] = _mm_add_epi32(bf0[19], bf0[20]);
        bf1[20] = _mm_sub_epi32(bf0[19], bf0[20]);
        bf1[21] = _mm_sub_epi32(bf0[18], bf0[21]);
        bf1[22] = _mm_sub_epi32(bf0[17], bf0[22]);
        bf1[23] = _mm_sub_epi32(bf0[16], bf0[23]);
        bf1[24] = _mm_sub_epi32(bf0[31], bf0[24]);
        bf1[25] = _mm_sub_epi32(bf0[30], bf0[25]);
        bf1[26] = _mm_sub_epi32(bf0[29], bf0[26]);
        bf1[27] = _mm_sub_epi32(bf0[28], bf0[27]);
        bf1[28] = _mm_add_epi32(bf0[27], bf0[28]);
        bf1[29] = _mm_add_epi32(bf0[26], bf0[29]);
        bf1[30] = _mm_add_epi32(bf0[25], bf0[30]);
        bf1[31] = _mm_add_epi32(bf0[24], bf0[31]);

        // stage 8
        bf0[0]  = _mm_add_epi32(bf1[0], bf1[15]);
        bf0[1]  = _mm_add_epi32(bf1[1], bf1[14]);
        bf0[2]  = _mm_add_epi32(bf1[2], bf1[13]);
        bf0[3]  = _mm_add_epi32(bf1[3], bf1[12]);
        bf0[4]  = _mm_add_epi32(bf1[4], bf1[11]);
        bf0[5]  = _mm_add_epi32(bf1[5], bf1[10]);
        bf0[6]  = _mm_add_epi32(bf1[6], bf1[9]);
        bf0[7]  = _mm_add_epi32(bf1[7], bf1[8]);
        bf0[8]  = _mm_sub_epi32(bf1[7], bf1[8]);
        bf0[9]  = _mm_sub_epi32(bf1[6], bf1[9]);
        bf0[10] = _mm_sub_epi32(bf1[5], bf1[10]);
        bf0[11] = _mm_sub_epi32(bf1[4], bf1[11]);
        bf0[12] = _mm_sub_epi32(bf1[3], bf1[12]);
        bf0[13] = _mm_sub_epi32(bf1[2], bf1[13]);
        bf0[14] = _mm_sub_epi32(bf1[1], bf1[14]);
        bf0[15] = _mm_sub_epi32(bf1[0], bf1[15]);
        bf0[16] = bf1[16];
        bf0[17] = bf1[17];
        bf0[18] = bf1[18];
        bf0[19] = bf1[19];
        ...
        // stage 9
        out[0 * 8 + col]  = _mm_add_epi32(bf0[0], bf0[31]);
        out[1 * 8 + col]  = _mm_add_epi32(bf0[1], bf0[30]);
        out[2 * 8 + col]  = _mm_add_epi32(bf0[2], bf0[29]);
        out[3 * 8 + col]  = _mm_add_epi32(bf0[3], bf0[28]);
        out[4 * 8 + col]  = _mm_add_epi32(bf0[4], bf0[27]);
        out[5 * 8 + col]  = _mm_add_epi32(bf0[5], bf0[26]);
        out[6 * 8 + col]  = _mm_add_epi32(bf0[6], bf0[25]);
        out[7 * 8 + col]  = _mm_add_epi32(bf0[7], bf0[24]);
        out[8 * 8 + col]  = _mm_add_epi32(bf0[8], bf0[23]);
        out[9 * 8 + col]  = _mm_add_epi32(bf0[9], bf0[22]);
        out[10 * 8 + col] = _mm_add_epi32(bf0[10], bf0[21]);
        out[11 * 8 + col] = _mm_add_epi32(bf0[11], bf0[20]);
        out[12 * 8 + col] = _mm_add_epi32(bf0[12], bf0[19]);
        out[13 * 8 + col] = _mm_add_epi32(bf0[13], bf0[18]);
        out[14 * 8 + col] = _mm_add_epi32(bf0[14], bf0[17]);
        out[15 * 8 + col] = _mm_add_epi32(bf0[15], bf0[16]);
        out[16 * 8 + col] = _mm_sub_epi32(bf0[15], bf0[16]);
        out[17 * 8 + col] = _mm_sub_epi32(bf0[14], bf0[17]);
        out[18 * 8 + col] = _mm_sub_epi32(bf0[13], bf0[18]);
        out[19 * 8 + col] = _mm_sub_epi32(bf0[12], bf0[19]);
        out[20 * 8 + col] = _mm_sub_epi32(bf0[11], bf0[20]);
        out[21 * 8 + col] = _mm_sub_epi32(bf0[10], bf0[21]);
        out[22 * 8 + col] = _mm_sub_epi32(bf0[9], bf0[22]);
        out[23 * 8 + col] = _mm_sub_epi32(bf0[8], bf0[23]);
        out[24 * 8 + col] = _mm_sub_epi32(bf0[7], bf0[24]);
        out[25 * 8 + col] = _mm_sub_epi32(bf0[6], bf0[25]);
        out[26 * 8 + col] = _mm_sub_epi32(bf0[5], bf0[26]);
        out[27 * 8 + col] = _mm_sub_epi32(bf0[4], bf0[27]);
        out[28 * 8 + col] = _mm_sub_epi32(bf0[3], bf0[28]);
        out[29 * 8 + col] = _mm_sub_epi32(bf0[2], bf0[29]);
        out[30 * 8 + col] = _mm_sub_epi32(bf0[1], bf0[30]);
        out[31 * 8 + col] = _mm_sub_epi32(bf0[0], bf0[31]);
    }
}
...
static const Transform1dSse41 highbd_txfm_all_1d_zeros_w8_arr[TX_SIZES][ITX_TYPES_1D][4] = {
    ...
    {{idct32x32_low1_sse4_1, idct32x32_low8_sse4_1, idct32x32_low16_sse4_1, idct32x32_sse4_1},
     {NULL, NULL, NULL, NULL},
     {iidentity32_sse4_1, NULL, NULL, NULL}},
    {{idct64x64_low1_sse4_1, idct64x64_low8_sse4_1, idct64x64_low16_sse4_1, idct64x64_general_sse4_1},
     {NULL, NULL, NULL, NULL},
     {NULL, NULL, NULL, NULL}}};

void svt_av1_inv_txfm2d_add_4x8_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
    ...
    const Transform1dSse41 row_txfm      = highbd_txfm_all_1d_zeros_w8_arr[txw_idx][hitx_1d_tab[tx_type]][0];
    const Transform1dSse41 col_txfm      = highbd_txfm_all_1d_zeros_w8_arr[txh_idx][vitx_1d_tab[tx_type]][1];
    ...
    // write to buffer
    highbd_write_buffer_4xn_sse4_1(buf1, output_r, stride_r, output_w, stride_w, ud_flip, txfm_size_row, bd);
}
...
static INLINE __m128i highbd_get_recon_8x8_sse4_1(const __m128i pred, __m128i res0, __m128i res1, const int32_t bd) {
    __m128i x0           = _mm_cvtepi16_epi32(pred);
...
static INLINE void highbd_write_buffer_8xn_sse4_1(__m128i *in, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
                                                  int32_t stride_w, int32_t flipud, int32_t height, const int32_t bd) {
    int32_t       j    = flipud ? (height - 1) : 0;
    const int32_t step = flipud ? -1 : 1;
    for (int32_t i = 0; i < height; ++i, j += step) {
...
void svt_av1_inv_txfm2d_add_8x4_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
    ...
    const int32_t          txfm_size_col = tx_size_wide[tx_size];
    const int32_t          txfm_size_row = tx_size_high[tx_size];
    const Transform1dSse41 row_txfm      = highbd_txfm_all_1d_zeros_w8_arr[txw_idx][hitx_1d_tab[tx_type]][1];
    const Transform1dSse41 col_txfm      = highbd_txfm_all_1d_zeros_w8_arr[txh_idx][vitx_1d_tab[tx_type]][0];
    ...
    for (int32_t i = 0; i < 2; i++) {
        col_txfm(
            buf1_ptr + i * txfm_size_row, buf1_ptr + i * txfm_size_row, inv_cos_bit_col[txw_idx][txh_idx], 1, bd, 0);
    }
    av1_round_shift_array_32_sse4_1(buf1_ptr, buf1_ptr, txfm_size_col, -shift[1]);
    // write to buffer
    highbd_write_buffer_8xn_sse4_1(buf1_ptr, output_r, stride_r, output_w, stride_w, ud_flip, txfm_size_row, bd);
}

//4x16
void svt_av1_inv_txfm2d_add_4x16_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
                                        int32_t stride_w, TxType tx_type, TxSize tx_size, int32_t bd) {
    __m128i                buf1[16];
    const int8_t          *shift           = svt_aom_inv_txfm_shift_ls[tx_size];
    const int32_t          txw_idx         = get_txw_idx(tx_size);
    ...
    const Transform1dSse41 row_txfm        = highbd_txfm_all_1d_zeros_w8_arr[txw_idx][hitx_1d_tab[tx_type]][0];
    const Transform1dSse41 col_txfm        = highbd_txfm_all_1d_zeros_w8_arr[txh_idx][vitx_1d_tab[tx_type]][2];
    const int32_t          input_stride    = AOMMIN(32, txfm_size_col);
    ...
    for (int32_t i = 0; i < (txfm_size_row >> 2); i++) {
        row_txfm(buf0 + (i << 2), buf0 + (i << 2), inv_cos_bit_row[txw_idx][txh_idx], 0, bd, -shift[0]);
    }
...
//16x4
void svt_av1_inv_txfm2d_add_16x4_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
                                        int32_t stride_w, TxType tx_type, TxSize tx_size, int32_t bd) {
    __m128i                buf1[16];
    const int8_t          *shift           = svt_aom_inv_txfm_shift_ls[tx_size];
    const int32_t          txw_idx         = get_txw_idx(tx_size);
    ...
    const Transform1dSse41 row_txfm        = highbd_txfm_all_1d_zeros_w8_arr[txw_idx][hitx_1d_tab[tx_type]][2];
    const Transform1dSse41 col_txfm        = highbd_txfm_all_1d_zeros_w8_arr[txh_idx][vitx_1d_tab[tx_type]][0];
...
typedef void (*transform_1d_sse4_1)(__m128i *in, __m128i *out, int bit, int do_cols, int bd, int out_shift);

static void svt_highbd_inv_txfm2d_add_no_identity_sse41(const int32_t *input, uint16_t *output_r, int32_t stride_r,
                                                        uint16_t *output_w, int32_t stride_w, TxType tx_type,
                                                        TxSize tx_size, int32_t eob, const int32_t bd) {
    __m128i buf1[64 * 16];
    int     eobx, eoby;
    ...
    const transform_1d_sse4_1 row_txfm  = highbd_txfm_all_1d_zeros_w8_arr[txw_idx][hitx_1d_tab[tx_type]][fun_idx_x];
    const transform_1d_sse4_1 col_txfm  = highbd_txfm_all_1d_zeros_w8_arr[txh_idx][vitx_1d_tab[tx_type]][fun_idx_y];
    ...
    for (int i = 0; i < buf_size_nonzero_h_div8 << 1; i++) {
        ...
        for (int j = 0; j < buf_size_nonzero_w_div8 << 1; ++j) {
            ...
            TRANSPOSE_4X4(
                buf0_cur[0], buf0_cur[1], buf0_cur[2], buf0_cur[3], buf0_cur[0], buf0_cur[1], buf0_cur[2], buf0_cur[3]);
        }
        if (rect_type == 1 || rect_type == -1) {
            av1_round_shift_rect_array_32_sse4_1(buf0, buf0, buf_size_nonzero_w_div8 << 3, 0, new_inv_sqrt2);
        }
        row_txfm(buf0, buf0, inv_cos_bit_row[txw_idx][txh_idx], 0, bd, -shift[0]);
        ...
        if (lr_flip) {
            ...
            for (int j = 0; j < buf_size_w_div8; ++j) {
                TRANSPOSE_4X4(buf0[j * 4 + 0],
                              buf0[j * 4 + 1],
                              buf0[j * 4 + 2],
                              buf0[j * 4 + 3],
                              _buf1[j * txfm_size_row + 0],
                              _buf1[j * txfm_size_row + 1],
                              _buf1[j * txfm_size_row + 2],
    ...
    for (int i = 0; i < buf_size_w_div8; i++) {
        ...
        av1_round_shift_array_32_sse4_1(buf1 + i * txfm_size_row, buf1 + i * txfm_size_row, txfm_size_row, -shift[1]);
    }
...
static void svt_highbd_inv_txfm2d_add_v_identity_ssse41(const int32_t *input, uint16_t *output_r, int32_t stride_r,
                                                        uint16_t *output_w, int32_t stride_w, TxType tx_type,
                                                        TxSize tx_size, int32_t eob, const int32_t bd) {
    __m128i buf1[64];
    int     eobx, eoby;
    ...
    const transform_1d_sse4_1 row_txfm        = highbd_txfm_all_1d_zeros_w8_arr[txw_idx][hitx_1d_tab[tx_type]][0];
    const transform_1d_sse4_1 col_txfm        = highbd_txfm_all_1d_zeros_w8_arr[txh_idx][vitx_1d_tab[tx_type]][fun_idx];
    int                       ud_flip, lr_flip;
    get_flip_cfg(tx_type, &ud_flip, &lr_flip);
    ...
    for (int i = 0; i < (buf_size_h_div8 << 1); ++i) {
        ...
        if (rect_type == 1 || rect_type == -1) {
            av1_round_shift_rect_array_32_sse4_1(buf0, buf0, input_stride, 0, new_inv_sqrt2);
        }
        row_txfm(buf0, buf0, inv_cos_bit_row[txw_idx][txh_idx], 0, bd, -shift[0]);
...
static void svt_highbd_inv_txfm2d_add_h_identity_ssse41(const int32_t *input, uint16_t *output_r, int32_t stride_r,
                                                        uint16_t *output_w, int32_t stride_w, TxType tx_type,
                                                        TxSize tx_size, int32_t eob, const int8_t bd) {
    __m128i buf1[64];
    int     eobx, eoby;
    ...
    const transform_1d_sse4_1 row_txfm = highbd_txfm_all_1d_zeros_w8_arr[txw_idx][hitx_1d_tab[tx_type]][fun_idx];
    const transform_1d_sse4_1 col_txfm = highbd_txfm_all_1d_zeros_w8_arr[txh_idx][vitx_1d_tab[tx_type]][0];
    int                       ud_flip, lr_flip;
    get_flip_cfg(tx_type, &ud_flip, &lr_flip);
...
static void svt_highbd_inv_txfm2d_add_idtx_ssse41(const int32_t *input, uint16_t *output_r, int32_t stride_r,
                                                  uint16_t *output_w, int32_t stride_w, TxType tx_type, TxSize tx_size,
...
void svt_av1_highbd_inv_txfm2d_add_universe_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r,
    ...
    case ADST_FLIPADST:
    case FLIPADST_ADST:
        svt_highbd_inv_txfm2d_add_no_identity_sse41(
            input, output_r, stride_r, output_w, stride_w, tx_type, tx_size, eob, bd);
        break;
    case V_DCT:
    case V_ADST:
    case V_FLIPADST:
        svt_highbd_inv_txfm2d_add_v_identity_ssse41(
            input, output_r, stride_r, output_w, stride_w, tx_type, tx_size, eob, bd);
        break;
    case H_DCT:
    case H_ADST:
    case H_FLIPADST:
        svt_highbd_inv_txfm2d_add_h_identity_ssse41(
            input, output_r, stride_r, output_w, stride_w, tx_type, tx_size, eob, bd);
        break;
    case IDTX:
        svt_highbd_inv_txfm2d_add_idtx_ssse41(input, output_r, stride_r, output_w, stride_w, tx_type, tx_size, eob, bd);
        break;
    default: assert(0); break;
    }
}

void svt_av1_highbd_inv_txfm_add_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
                                        int32_t stride_w, TxType tx_type, TxSize tx_size, int32_t eob, int32_t bd) {
    svt_av1_highbd_inv_txfm2d_add_universe_sse4_1(
        input, output_r, stride_r, output_w, stride_w, tx_type, tx_size, eob, bd);
}

static void load_buffer_32x32(const int32_t *coeff, __m128i *in) {
    int32_t i;
    for (i = 0; i < 256; ++i) {
        in[i] = _mm_loadu_si128((const __m128i *)coeff);
        coeff += 4;
    }
}
...
void svt_av1_inv_txfm2d_add_32x32_sse4_1(const int32_t *input, uint16_t *output_r, int32_t stride_r, uint16_t *output_w,
                                         int32_t stride_w, TxType tx_type, int32_t bd) {
    __m128i       in[256], out[256];
    ...
    case DCT_DCT:
        ...
        idct32_sse4_1(out, in, inv_cos_bit_row[txw_idx][txh_idx]);
        round_shift_32x32(in, -shift[0]);
        transpose_8nx8n(in, out, 32, 32);
        idct32_sse4_1(out, in, inv_cos_bit_col[txw_idx][txh_idx]);
