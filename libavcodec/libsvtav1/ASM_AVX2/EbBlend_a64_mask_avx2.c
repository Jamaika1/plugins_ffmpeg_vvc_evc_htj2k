...
#include "../ASM_SSE4_1/EbBlend_sse4.h"
...
static INLINE __m256i blend_16_u8_avx2(const uint8_t *src0, const uint8_t *src1,
    ...
    const __m256i v_p0_w = _mm256_maddubs_epi16(_mm256_unpacklo_epi8(v_s0_s_b, v_s1_s_b),
...
static INLINE __m256i blend_32_u8_avx2(const uint8_t *src0, const uint8_t *src1,
    ...
    const __m256i v_p0_w = _mm256_maddubs_epi16(_mm256_unpacklo_epi8(v_s0_b, v_s1_b),
                                                _mm256_unpacklo_epi8(*v_m0_b, *v_m1_b));
    const __m256i v_p1_w = _mm256_maddubs_epi16(_mm256_unpackhi_epi8(v_s0_b, v_s1_b),
...
static INLINE void blend_a64_mask_sx_sy_w16_avx2(uint8_t *dst, uint32_t dst_stride,
    ...
    do {
        ...
        const __m256i v_rvsbl_w = _mm256_and_si256(_mm256_srli_si256(v_rvsl_b, 1), v_zmask_b);
...
static INLINE void blend_a64_mask_sx_sy_w32n_avx2(uint8_t *dst, uint32_t dst_stride,
                                                  const uint8_t *src0, uint32_t src0_stride,
                                                  const uint8_t *src1, uint32_t src1_stride,
    ...
    do {
        ...
        for (c = 0; c < w; c += 32) {
            ...
            const __m256i v_rvsbl_w = _mm256_and_si256(_mm256_srli_si256(v_rvsl_b, 1), v_zmask_b);
            const __m256i v_rvsbh_w = _mm256_and_si256(_mm256_srli_si256(v_rvsh_b, 1), v_zmask_b);
            const __m256i v_rsl_w   = _mm256_add_epi16(v_rvsal_w, v_rvsbl_w);
...
static INLINE void blend_a64_mask_sx_sy_avx2(uint8_t *dst, uint32_t dst_stride, const uint8_t *src0,
    ...
    case 16:
        blend_a64_mask_sx_sy_w16_avx2(
            dst, dst_stride, src0, src0_stride, src1, src1_stride, mask, mask_stride, h);
        break;
    default:
...
static INLINE void blend_a64_mask_sx_w16_avx2(uint8_t *dst, uint32_t dst_stride,
                                              const uint8_t *src0, uint32_t src0_stride,
                                              const uint8_t *src1, uint32_t src1_stride,
                                              const uint8_t *mask, uint32_t mask_stride, int h) {
    const __m256i v_maxval_b = _mm256_set1_epi8(AOM_BLEND_A64_MAX_ALPHA);
    ...
    do {
        ...
        const __m256i v_al_b = _mm256_avg_epu8(v_rl_b, _mm256_srli_si256(v_rl_b, 1));
...
static INLINE void blend_a64_mask_sx_w32n_avx2(uint8_t *dst, uint32_t dst_stride,
                                               const uint8_t *src0, uint32_t src0_stride,
                                               const uint8_t *src1, uint32_t src1_stride,
                                               const uint8_t *mask, uint32_t mask_stride, int w,
                                               int h) {
...
static INLINE void blend_a64_mask_sx_avx2(uint8_t *dst, uint32_t dst_stride, const uint8_t *src0,
                                          uint32_t src0_stride, const uint8_t *src1,
                                          uint32_t src1_stride, const uint8_t *mask,
                                          uint32_t mask_stride, int w, int h) {
    const __m128i v_shuffle_b = xx_loadu_128(g_blend_a64_mask_shuffle);
...
static INLINE void blend_a64_mask_sy_w16_avx2(uint8_t *dst, uint32_t dst_stride,
                                              const uint8_t *src0, uint32_t src0_stride,
                                              const uint8_t *src1, uint32_t src1_stride,
                                              const uint8_t *mask, uint32_t mask_stride, int h) {
    const __m128i _r         = _mm_set1_epi16(1 << (15 - AOM_BLEND_A64_ROUND_BITS));
...
static INLINE void blend_a64_mask_sy_w32n_avx2(uint8_t *dst, uint32_t dst_stride,
                                               const uint8_t *src0, uint32_t src0_stride,
                                               const uint8_t *src1, uint32_t src1_stride,
                                               const uint8_t *mask, uint32_t mask_stride, int w,
                                               int h) {
...
static INLINE void blend_a64_mask_sy_avx2(uint8_t *dst, uint32_t dst_stride, const uint8_t *src0,
                                          uint32_t src0_stride, const uint8_t *src1,
                                          uint32_t src1_stride, const uint8_t *mask,
                                          uint32_t mask_stride, int w, int h) {
    const __m128i _r         = _mm_set1_epi16(1 << (15 - AOM_BLEND_A64_ROUND_BITS));
...
static INLINE void blend_a64_mask_avx2(uint8_t *dst, uint32_t dst_stride, const uint8_t *src0,
                                       uint32_t src0_stride, const uint8_t *src1,
                                       uint32_t src1_stride, const uint8_t *mask,
                                       uint32_t mask_stride, int w, int h) {
    const __m128i v_maxval_b = _mm_set1_epi8(AOM_BLEND_A64_MAX_ALPHA);
...
static INLINE void blend_a64_d16_mask_w16_avx2(uint8_t *dst, const CONV_BUF_TYPE *src0,
                                               const CONV_BUF_TYPE *src1, const __m256i *m0,
                                               const __m256i *v_round_offset,
    ...
    res0_lo            = _mm256_srai_epi32(_mm256_sub_epi32(res0_lo, *v_round_offset), shift);
    res0_hi            = _mm256_srai_epi32(_mm256_sub_epi32(res0_hi, *v_round_offset), shift);
...
static INLINE void blend_a64_d16_mask_w32_avx2(uint8_t *dst, const CONV_BUF_TYPE *src0,
                                               const CONV_BUF_TYPE *src1, const __m256i *m0,
                                               const __m256i *m1, const __m256i *v_round_offset,
                                               const __m256i *v_maxval, int shift) {
    const __m256i max_minus_m0 = _mm256_sub_epi16(*v_maxval, *m0);
    ...
    res0_lo            = _mm256_srai_epi32(_mm256_sub_epi32(res0_lo, *v_round_offset), shift);
    res0_hi            = _mm256_srai_epi32(_mm256_sub_epi32(res0_hi, *v_round_offset), shift);
    res1_lo            = _mm256_srai_epi32(_mm256_sub_epi32(res1_lo, *v_round_offset), shift);
    res1_hi            = _mm256_srai_epi32(_mm256_sub_epi32(res1_hi, *v_round_offset), shift);
    const __m256i res0 = _mm256_packs_epi32(res0_lo, res0_hi);
...
static INLINE void lowbd_blend_a64_d16_mask_subw0_subh0_w16_avx2(
    ...
    int h, const __m256i *round_offset, int shift) {
    ...
    for (int i = 0; i < h; ++i) {
        ...
        blend_a64_d16_mask_w16_avx2(dst, src0, src1, &m0, round_offset, &v_maxval, shift);
        mask += mask_stride;
        dst += dst_stride;
        src0 += src0_stride;
        src1 += src1_stride;
...
static INLINE void lowbd_blend_a64_d16_mask_subw0_subh0_w32_avx2(
    uint8_t *dst, uint32_t dst_stride, const CONV_BUF_TYPE *src0, uint32_t src0_stride,
    const CONV_BUF_TYPE *src1, uint32_t src1_stride, const uint8_t *mask, uint32_t mask_stride,
    int h, int w, const __m256i *round_offset, int shift) {
    const __m256i v_maxval = _mm256_set1_epi16(AOM_BLEND_A64_MAX_ALPHA);
    for (int i = 0; i < h; ++i) {
        for (int j = 0; j < w; j += 32) {
            ...
            blend_a64_d16_mask_w32_avx2(
                dst + j, src0 + j, src1 + j, &m0, &m1, round_offset, &v_maxval, shift);
        }
        mask += mask_stride;
        dst += dst_stride;
        src0 += src0_stride;
    ...
    for (int i = 0; i < h; ++i) {
        for (int j = 0; j < w; j += 16) {
            ...
            blend_a64_d16_mask_w16_avx2(
                dst + j, src0 + j, src1 + j, &m0, round_offset, &v_maxval, shift);
        }
        mask += mask_stride;
        dst += dst_stride;
        src0 += src0_stride;
...
static INLINE void lowbd_blend_a64_d16_mask_subw0_subh1_w32_avx2(
    ...
    for (int i = 0; i < h; ++i) {
        for (int j = 0; j < w; j += 32) {
            ...
            const __m256i m_ac = _mm256_avg_epu8(_mm256_adds_epu8(m_i00, m_i10), zeros);
            const __m256i m0   = _mm256_cvtepu8_epi16(_mm256_castsi256_si128(m_ac));
            const __m256i m1   = _mm256_cvtepu8_epi16(_mm256_extracti128_si256(m_ac, 1));
...
void svt_aom_lowbd_blend_a64_d16_mask_avx2(uint8_t *dst, uint32_t dst_stride,
    ...
    if (subw == 0 && subh == 0) {
        switch (w) {
        case 4:
            aom_lowbd_blend_a64_d16_mask_subw0_subh0_w4_sse4_1(dst,
                                                               dst_stride,
                                                               src0,
                                                               src0_stride,
                                                               src1,
            ...
            break;
        case 8:
            aom_lowbd_blend_a64_d16_mask_subw0_subh0_w8_sse4_1(dst,
                                                               dst_stride,
                                                               src0,
                                                               src0_stride,
                                                               src1,
            ...
            break;
        case 16:
            lowbd_blend_a64_d16_mask_subw0_subh0_w16_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
            ...
            break;
        default:
            lowbd_blend_a64_d16_mask_subw0_subh0_w32_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
        ...
        switch (w) {
        case 4:
            aom_lowbd_blend_a64_d16_mask_subw1_subh1_w4_sse4_1(dst,
                                                               dst_stride,
                                                               src0,
                                                               src0_stride,
                                                               src1,
            ...
            break;
        case 8:
            aom_lowbd_blend_a64_d16_mask_subw1_subh1_w8_sse4_1(dst,
                                                               dst_stride,
                                                               src0,
                                                               src0_stride,
                                                               src1,
            ...
            break;
        case 16:
            lowbd_blend_a64_d16_mask_subw1_subh1_w16_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
            ...
            break;
        default:
            lowbd_blend_a64_d16_mask_subw1_subh1_w32_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
        ...
        switch (w) {
        case 4:
            aom_lowbd_blend_a64_d16_mask_subw1_subh0_w4_sse4_1(dst,
                                                               dst_stride,
                                                               src0,
                                                               src0_stride,
                                                               src1,
            ...
            break;
        case 8:
            aom_lowbd_blend_a64_d16_mask_subw1_subh0_w8_sse4_1(dst,
                                                               dst_stride,
                                                               src0,
                                                               src0_stride,
                                                               src1,
            ...
            break;
        case 16:
            lowbd_blend_a64_d16_mask_subw1_subh0_w16_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
            ...
            break;
        default:
            lowbd_blend_a64_d16_mask_subw1_subh0_w32_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
        ...
        switch (w) {
        case 4:
            aom_lowbd_blend_a64_d16_mask_subw0_subh1_w4_sse4_1(dst,
                                                               dst_stride,
                                                               src0,
                                                               src0_stride,
                                                               src1,
            ...
            break;
        case 8:
            aom_lowbd_blend_a64_d16_mask_subw0_subh1_w8_sse4_1(dst,
                                                               dst_stride,
                                                               src0,
                                                               src0_stride,
                                                               src1,
            ...
            break;
        case 16:
            lowbd_blend_a64_d16_mask_subw0_subh1_w16_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
            ...
            break;
        default:
            lowbd_blend_a64_d16_mask_subw0_subh1_w32_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
...
static INLINE void highbd_blend_a64_d16_mask_w4_avx2(
    ...
    const __m256i roundh = _mm256_srai_epi32(_mm256_sub_epi32(sumh, *round_offset), shift);
    const __m256i roundl = _mm256_srai_epi32(_mm256_sub_epi32(suml, *round_offset), shift);
...
static INLINE void highbd_blend_a64_d16_mask_subw0_subh0_w4_avx2(
    uint16_t *dst, uint32_t dst_stride, const CONV_BUF_TYPE *src0, uint32_t src0_stride,
    const CONV_BUF_TYPE *src1, uint32_t src1_stride, const uint8_t *mask, uint32_t mask_stride,
...
static INLINE void highbd_blend_a64_d16_mask_subw0_subh0_w8_avx2(
    uint16_t *dst, int dst_stride, const CONV_BUF_TYPE *src0, int src0_stride,
    const CONV_BUF_TYPE *src1, int src1_stride, const uint8_t *mask, int mask_stride, int h,
    const __m256i *round_offset, int shift, const __m256i *clip_low, const __m256i *clip_high,
    const __m256i *mask_max) {
    do {
        ...
        highbd_blend_a64_d16_mask_w8_avx2(dst,
                                          dst_stride,
                                          src0,
                                          src0_stride,
                                          src1,
...
static INLINE void highbd_blend_a64_d16_mask_subw1_subh1_w8_avx2(
    ...
    do {
        ...
        const __m256i mask_0a = _mm256_srli_epi16(_mm256_add_epi16(m0123, two_w), 2);
        const __m256i m46     = yy_loadu2_128(mask + 4 * mask_stride, mask + 6 * mask_stride);
        const __m256i m57     = yy_loadu2_128(mask + 5 * mask_stride, mask + 7 * mask_stride);
        const __m256i m4567   = _mm256_maddubs_epi16(_mm256_adds_epu8(m46, m57), one_b);
        const __m256i mask_0b = _mm256_srli_epi16(_mm256_add_epi16(m4567, two_w), 2);
...
static INLINE void highbd_blend_a64_d16_mask_w16_avx2(
    ...
    const __m256i resah = _mm256_srai_epi32(_mm256_sub_epi32(mulah, *round_offset), shift);
    const __m256i resal = _mm256_srai_epi32(_mm256_sub_epi32(mulal, *round_offset), shift);
...
static INLINE void highbd_blend_a64_d16_mask_subw0_subh0_w16_avx2(
    uint16_t *dst, int dst_stride, const CONV_BUF_TYPE *src0, int src0_stride,
    const CONV_BUF_TYPE *src1, int src1_stride, const uint8_t *mask, int mask_stride, int h, int w,
    const __m256i *round_offset, int shift, const __m256i *clip_low, const __m256i *clip_high,
    const __m256i *mask_max) {
    for (int i = 0; i < h; i += 2) {
        for (int j = 0; j < w; j += 16) {
            ...
            highbd_blend_a64_d16_mask_w16_avx2(dst + j,
                                               dst_stride,
                                               src0 + j,
                                               src0_stride,
                                               src1 + j,
...
void svt_aom_highbd_blend_a64_d16_mask_avx2(uint8_t *dst8, uint32_t dst_stride,
    ...
    if (subw == 0 && subh == 0) {
        switch (w) {
        case 4:
            highbd_blend_a64_d16_mask_subw0_subh0_w4_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
            ...
            break;
        case 8:
            highbd_blend_a64_d16_mask_subw0_subh0_w8_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
        ...
        switch (w) {
        case 4:
            highbd_blend_a64_d16_mask_subw1_subh1_w4_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
            ...
            break;
        case 8:
            highbd_blend_a64_d16_mask_subw1_subh1_w8_avx2(dst,
                                                          dst_stride,
                                                          src0,
                                                          src0_stride,
                                                          src1,
