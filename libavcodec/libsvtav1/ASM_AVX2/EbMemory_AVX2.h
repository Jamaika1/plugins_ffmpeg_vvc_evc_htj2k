...
static INLINE __m256i load_u8_8x2_avx2(const uint8_t *const src, const ptrdiff_t stride) {
...
static INLINE __m256i loadu_u8_16x2_avx2(const uint8_t *const src, const ptrdiff_t stride) {
    return loadu_8bit_16x2_avx2(src, sizeof(*src) * stride);
}

static INLINE __m256i loadu_u16_8x2_avx2(const uint16_t *const src, const ptrdiff_t stride) {
    return loadu_8bit_16x2_avx2(src, sizeof(*src) * stride);
}
