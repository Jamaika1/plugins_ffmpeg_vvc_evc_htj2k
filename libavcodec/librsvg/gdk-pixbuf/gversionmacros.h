...
#define GMODULE_VERSION_CUR_STABLE         (G_ENCODE_VERSION (GMODULE_MAJOR_VERSION, GMODULE_MINOR_VERSION + 1))
#else
#define GMODULE_VERSION_CUR_STABLE         (G_ENCODE_VERSION (GMODULE_MAJOR_VERSION, GMODULE_MINOR_VERSION))
#endif
 ...
 */
#if (GMODULE_MINOR_VERSION % 2)
#define GMODULE_VERSION_PREV_STABLE        (G_ENCODE_VERSION (GMODULE_MAJOR_VERSION, GMODULE_MINOR_VERSION - 1))
#else
#define GMODULE_VERSION_PREV_STABLE        (G_ENCODE_VERSION (GMODULE_MAJOR_VERSION, GMODULE_MINOR_VERSION - 2))
#endif
