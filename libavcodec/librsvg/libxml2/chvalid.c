 ...
 *
 */
unsigned char xmlIsPubidChar_unsafe(int c)
{
...
const xmlChRangeGroup *xmlIsBaseCharGroup(void)
{
	static const xmlChRangeGroup g =
...
const xmlChRangeGroup *xmlIsCharGroup(void)
{
	static const xmlChRangeGroup g =
...
const xmlChRangeGroup *xmlIsCombiningGroup(void)
{
	static const xmlChRangeGroup g =
...
static const xmlChSRange xmlIsDigit_srng[] = { {0x660, 0x669},
    ...
    {0xf20, 0xf29}};
const xmlChRangeGroup *xmlIsDigitGroup(void)
{
	static const xmlChRangeGroup g =
...
static const xmlChSRange xmlIsExtender_srng[] = { {0x2d0, 0x2d0},
    ...
    {0x30fc, 0x30fe}};
const xmlChRangeGroup *xmlIsExtenderGroup(void)
{
	static const xmlChRangeGroup g =
...
const xmlChRangeGroup *xmlIsIdeographicGroup(void)
{
	static const xmlChRangeGroup g =
