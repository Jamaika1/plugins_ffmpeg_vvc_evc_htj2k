...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/freetype
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -D__FTERRORS_H__=1 -UFTERRORS_H_ -DFT2_BUILD_LIBRARY=1 -DTT_CONFIG_OPTION_COLOR_LAYERS=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/freetype/autofit
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -D__FTERRORS_H__=1 -UFTERRORS_H_ -DFT2_BUILD_LIBRARY=1 -DFT_CONFIG_OPTION_USE_HARFBUZZ=1 -c %%f -o %%~nf.o
cd ../../..
cd librsvg/freetype/bdf
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -D__FTERRORS_H__=1 -UFTERRORS_H_ -DFT2_BUILD_LIBRARY=1 -c %%f -o %%~nf.o
cd ../../..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -D__FTERRORS_H__=1 -UFTERRORS_H_ -DFT2_BUILD_LIBRARY=1 -DWIN32=1 -c %%f -o %%~nf.o
cd ../../..
...
cd ../../..
cd librsvg/fribidi
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DFRIBIDI_LIB_STATIC=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGIZE=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/harfbuzz
for %%f in ("harfbuzz.cc") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -DHAVE_CAIRO=1 -DHAVE_FREETYPE=1 -DHAVE_GLIB=1 -DHAVE_GOBJECT=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/libxml2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/cairo
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/pixman
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DPACKAGE=1 -DUSE_X86_MMX=1 -DUSE_SSE2=1 -DUSE_SSSE3=1 -c %%f -o %%~nf.o
cd ../..

cd librsvg
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DRSVG_STATIC=1 -DRSVG_COMPILATION=1 -c %%f -o %%~nf.o
cd ..
cd librsvg/glib
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DPCRE2_STATIC=1 -DPCRE2_CODE_UNIT_WIDTH=8 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -DPTW32_STATIC_LIB=1 -DHAVE_PTHREAD_CONDATTR_SETCLOCK=1 -DCLOCK_MONOTONIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gio
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gobject
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gdk-pixbuf
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gmodule
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd librsvg/pango
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DFRIBIDI_LIB_STATIC=1 -DLIBXML_STATIC=1 -DSYSCONFDIR=\"/etc\" -DLIBDIR=\"/pango\" -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGIZE=1 -c %%f -o %%~nf.o
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DFRIBIDI_LIB_STATIC=1 -DLIBXML_STATIC=1 -DSYSCONFDIR=\"/etc\" -DLIBDIR=\"/pango\" -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGIZE=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/pcre2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DPCRE2_STATIC=1 -DPCRE2_CODE_UNIT_WIDTH=8 -c %%f -o %%~nf.o
cd ../..
cd librsvg/libcroco
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
...
cd librsvg/libffi
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
echo for %%f in ("%~dp1*.S") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -c %%f -o %%~nf.o
cd ../..
echo cd librsvg/fnmatch
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
echo cd ../..
echo cd librsvg/libintl
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DNIN_LIBASPRINTF -DNO_XMALLOC -DHAVE_STDINT_H_WITH_UINTMAX -DHAVE_GETCWD -DUSE_WINDOWS_THREADS=1 -DHAVE_MEMPCPY=1 -DHAVE_TSEARCH=1 -DNSTATIC="" -DLOCALEDIR=\"/usr/share/locale\" -DLOCALE_ALIAS_PATH=\"/usr/share/locale/locale.alias\" -DLIBDIR=\"/libintl\" -DIN_LIBINTL -DLIBINTL_VERSION=0x001500 -DNWIDE_CHAR_VERSION -c %%f -o %%~nf.o
echo cd ../..
cd librsvg/libpng
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DPNG_DEBUG=1 -DNZLIB_WINAPI -DPNG_DLL_EXPORT=/"/" -c %%f -o %%~nf.o
cd ../..
cd librsvg/zlib
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DNZLIB_DLL -c %%f -o %%~nf.o
cd ../..
cd librsvg/lzma
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_STDBOOL_H=1 -DHAVE_STDINT_H=1 -DMYTHREAD_ENABLED=1 -DMYTHREAD_VISTA=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/bzip2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DBZ_LCCWIN32=1 -c %%f -o %%~nf.o
cd ../..

cd libtwolame
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DLIBTWOLAME_STATIC=1 -c %%f -o %%~nf.o
cd ..
cd libogg
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ..
cd libtheora/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DCAIRO_WIN32_STATIC_BUILD=1 -DHAVE_CAIRO=1 -DNOC_DUMP_IMAGES -DNOC_COLLECT_METRICS -DNHAVE_MEMORY_CONSTRAINT -DOC_STATE_USE_VTABLE=1 -DOC_X86_ASM=1 -DOC_X86_64_ASM=1 -c %%f -o %%~nf.o
cd ../..
cd libtheora
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DCAIRO_WIN32_STATIC_BUILD=1 -DHAVE_CAIRO=1 -DNOC_DUMP_IMAGES -DNOC_COLLECT_METRICS -DNHAVE_MEMORY_CONSTRAINT -DOC_STATE_USE_VTABLE=1 -DOC_X86_ASM=1 -DOC_X86_64_ASM=1 -c %%f -o %%~nf.o
cd ..
cd libsnappy
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_ATTRIBUTE_ALWAYS_INLINE=1 -DHAVE_BUILTIN_CTZ=1 -DHAVE_BUILTIN_EXPECT=1 -DHAVE_BUILTIN_PREFETCH=1 -DSNAPPY_HAVE_SSSE3=1 -DNSNAPPY_HAVE_BMI2 -c %%f -o %%~nf.o
cd ..
cd libshine
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ..
cd libmp3lame
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DSTDC_HEADERS=1 -DNHAVE_ERRNO_H -DHAVE_FCNTL_H=1 -DHAVE_STDINT_H=1 -DNHAVE_NASM -DHAVE_XMMINTRIN_H=1 -DUSE_FAST_LOG=1 -c %%f -o %%~nf.o
cd ..
cd libgsm
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DNeedFunctionPrototypes=1 -DSASR -DWAV49 -c %%f -o %%~nf.o
cd ..
cd libvorbis
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DUSE_MEMORY_H=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -c %%f -o %%~nf.o
cd ..
cd libcodec2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DFIXED_POINT=1 -DNUSE_SIMD -DUSE_KISS_FFT="" -c %%f -o %%~nf.o
cd ..
cd libspeex
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DFIXED_POINT=1 -DNUSE_SIMD -DUSE_KISS_FFT="" -c %%f -o %%~nf.o
cd ..
cd libcelt2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DFIXED_POINT=1 -DNUSE_SIMD -c %%f -o %%~nf.o
cd ..
cd libcelt
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DFIXED_POINT=1 -DNUSE_SIMD -DPACKAGE_VERSION=\"1.4.0-82ac57d\" -c %%f -o %%~nf.o
cd ..
cd libcelt/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DFIXED_POINT=1 -DNUSE_SIMD -DCPU_INFO_BY_ASM=1 -c %%f -o %%~nf.o
cd ../..

cd libopus
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -c %%f -o %%~nf.o
cd ..
cd libsilk
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -c %%f -o %%~nf.o
cd ..
...
cd ../../..
cd libkvazaar
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DKVZ_BIT_DEPTH=8 -DKVZ_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -c %%f -o %%~nf.o
cd ..
cd libkvazaar/altivec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DKVZ_BIT_DEPTH=8 -DKVZ_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libuvg266
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_BIT_DEPTH=8 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -c %%f -o %%~nf.o
cd ..
cd libuvg266/altivec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_BIT_DEPTH=8 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
cd libuvg266/sse2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_BIT_DEPTH=8 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libpthread_win32
for %%f in ("pthread.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ..
cd libopenjpeg
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -D__SSE__ -D__SSE2__ -DOPJ_STATIC=1 -DUSE_JPIP -c %%f -o %%~nf.o
cd ..
cd liblcms2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DCMS_IS_WINDOWS_ -DCMS_RELY_ON_WINDOWS_STATIC_MUTEX_INIT -D__LITTLE_ENDIAN__ -c %%f -o %%~nf.o
cd ..
cd libwebp/dec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DWEBP_USE_THREAD -DWEBP_EXTERN=extern -c %%f -o %%~nf.o
cd ../..
cd libwebp/demux
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DWEBP_USE_THREAD -DWEBP_EXTERN=extern -c %%f -o %%~nf.o
cd ../..
...
echo cd ..
cd libfdk-aac
for %%f in ("%~dp1*.cpp") do gcc.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ..
cd libxavs
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DNHAVE_MMX -DARCH_X86_64=1 -DNHAVE_MMXEXT -DNHAVE_SSE2 -DNHAVE_SSSE3 -DNHAVE_SSE4 -DXAVS_VERSION=1 -DMP4_OUTPUT=1 -DHAVE_STDINT_H=1 -D__WIN32__=1 -c %%f -o %%~nf.o
cd ..
cd libxavs2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -c %%f -o %%~nf.o
cd ..
cd libxavs2/vec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -c %%f -o %%~nf.o
cd ../..
cd libxavs2/vec/avx2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -c %%f -o %%~nf.o
cd ../../..
cd libdavs2
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=10 -DHIGH_BIT_DEPTH=1 -DHAVE_WIN32THREAD=1 -DSYS_WINDOWS=1 -c %%f -o %%~nf.o
cd ..
cd libdavs2/vec
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=10 -DHIGH_BIT_DEPTH=1 -DHAVE_WIN32THREAD=1 -DSYS_WINDOWS=1 -c %%f -o %%~nf.o
cd ../..
cd libdavs2/vec/avx2
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=10 -DHIGH_BIT_DEPTH=1 -DHAVE_WIN32THREAD=1 -DSYS_WINDOWS=1 -c %%f -o %%~nf.o
cd ../../..
cd libuavs3d
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=0 -DUAVS3D_STATIC=1 -c %%f -o %%~nf.o
cd ..
cd libuavs3d/sse
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=0 -DUAVS3D_STATIC=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libuavs3e
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=0 -DUAVS3E_STATIC=1 -c %%f -o %%~nf.o
cd ..
cd libuavs3e/sse
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=0 -DUAVS3E_STATIC=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libxvid
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_IS_64BIT=1 -DARCH_IS_X86_64=1 -c %%f -o %%~nf.o
cd ..
cd libopenh264/processing
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DX86_ASM -DHAVE_AVX2=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libxevd
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DWINDOWS_MUTEX_SYNC=0 -c %%f -o %%~nf.o
cd ..
cd libxevd/avx2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DWINDOWS_MUTEX_SYNC=0 -c %%f -o %%~nf.o
cd ../..
cd libxeve
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DWINDOWS_MUTEX_SYNC=0 -DENABLE_IBC_CHROMA_REFINE=0 -c %%f -o %%~nf.o
cd ..
cd libxeve/avx2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DWINDOWS_MUTEX_SYNC=0 -DENABLE_IBC_CHROMA_REFINE=0 -c %%f -o %%~nf.o
cd ../..
...
cd libsvtav1
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -c %%f -o %%~nf.o
cd ..
cd libsvtav1/ASM_SSE4_1
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../..
cd libsvtav1/cpuinfo
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNOMINMAX -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -DCPUINFO_MOCK=1 -DCPUINFO_LOG_LEVEL=2 -c %%f -o %%~nf.o
cd ../..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../../..
cd libaom/av1c/x86/avx2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../../../..
cd libaom/av1dsp
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../..
cd libaom/av1dsp/x86/avx2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../../../..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../../../..
cd libaom/av1dsp/flow_estimation/x86/avx2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../../../../..
cd libaom/av1d
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DBROTLI_HAVE_LOG2=1 -c %%f -o %%~nf.o
cd ../../..
...
cd libjxl
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNJPEGXL_ENABLE_SKCMS -DJXL_DEBUG_WARNING=1 -DJXL_CRASH_ON_ERROR=1 -DJXL_DEBUG_ON_ALL_ERROR=1 -DHWY_COMPILE_ONLY_STATIC -DNFJXL_ENABLE_AVX2 -DJPEGXL_VERSION=\"0.9.0-88cb6b8\" -c %%f -o %%~nf.o
cd ..
cd libjxl/base
...
cd libx264
for %%f in ("%~dp1*.c") do gcc.exe -static -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DHIGH_BIT_DEPTH=0 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -DHAVE_X86_INLINE_ASM=1 -c %%f -o %%~nf.o
cd ..
cd libx264_10bit
for %%f in ("%~dp1*.c") do gcc.exe -static -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=10 -DHIGH_BIT_DEPTH=1 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -DHAVE_X86_INLINE_ASM=1 -c %%f -o %%~nf.o
cd ..
cd libx265/vec
for %%f in ("%~dp1*.cpp") do g++.exe -static -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+103-8f18e3a -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
cd libx265_10bit/vec
for %%f in ("%~dp1*.cpp") do g++.exe -static -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=0 -DX265_NS=x265_10bit -DX86_64=1 -DX265_VERSION=3.5+103-8f18e3a -DHIGH_BIT_DEPTH=1 -DX265_DEPTH=10 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
cd libx265_12bit/vec
for %%f in ("%~dp1*.cpp") do g++.exe -static -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=0 -DX265_NS=x265_12bit -DX86_64=1 -DX265_VERSION=3.5+103-8f18e3a -DHIGH_BIT_DEPTH=1 -DX265_DEPTH=12 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
cd libx265
for %%f in ("%~dp1*.cpp") do g++.exe -static -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+103-8f18e3a -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ..
...
for %%f in ("%~dp1*.cpp") do g++.exe -static -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+103-8f18e3a -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..

cd libkvazaar/x86_asm
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -c %%f -o %%~nf.o
...
for %%f in ("%~dp1*.asm") do nasm.exe -f win64 -O3 -DWIN64=1 -DNPREFIX -DHAVE_AVX2=1 -Xgnu %%f -o %%~nf.o
cd ../../..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -c %%f -o %%~nf.o
for %%f in ("%~dp1*.asm") do nasm.exe -f win64 -O3 -DARCH_X86_64=1 -DCONFIG_PIC=1 -DCONFIG_AV1_ENCODER=1 -DNCONFIG_AV1_DECODER=0 -DHAVE_AVX2=1 -Xgnu %%f -o %%~nf.o
cd ../..
cd libsvtav1/ASM_SSSE3
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -c %%f -o %%~nf.o
for %%f in ("%~dp1*.asm") do nasm.exe -f win64 -O3 -DARCH_X86_64=1 -DCONFIG_PIC=1 -DCONFIG_AV1_ENCODER=1 -DNCONFIG_AV1_DECODER=0 -DHAVE_AVX2=1 -Xgnu %%f -o %%~nf.o
cd ../..
cd libsvtav1/ASM_AVX2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -c %%f -o %%~nf.o
for %%f in ("%~dp1*.asm") do nasm.exe -f win64 -O3 -DARCH_X86_32=0 -DARCH_X86_64=1 -DWIN64=1 -DPIC=1 -DFORCE_VEX_ENCODING=0 -Dprivate_prefix=svt_dav1d -Dpublic_prefix=svt_dav1d -Xgnu %%f -o %%~nf.o
cd ../..
cd libaom/av1dsp/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
for %%f in ("%~dp1*.asm") do nasm.exe -f win64 -O3 -DAOM_ARCH_X86=0 -DAOM_ARCH_X86_64=1 -DCONFIG_PIC=1 -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DHAVE_AVX2=1 -Xgnu %%f -o %%~nf.o
cd ../../..
cd libdav1d/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -D__USE_MINGW_ANSI_STDIO=1 -DUNICODE=1 -D_UNICODE=1 -D_CRT_DECLARE_NONSTDC_NAMES=1 -DARCH_X86=1 -DARCH_X86_32=0 -DARCH_X86_64=1 -DHAVE_ASM=1 -DCONFIG_8BPC -DCONFIG_16BPC -DBITDEPTH=8 -DHAVE_ALIGNED_MALLOC=1 -c %%f -o %%~nf.o
...
cd ../..
cd libx264/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DHIGH_BIT_DEPTH=0 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -DHAVE_X86_INLINE_ASM=1 -c %%f -o %%~nf.o
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=10 -DHIGH_BIT_DEPTH=1 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -DHAVE_X86_INLINE_ASM=1 -c %%f -o %%~nf.o
...
cd ../..
cd libx265/x86
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+103-8f18e3a -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DNX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
cd ../..
cd libavutil
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -DCL_TARGET_OPENCL_VERSION=300 -c %%f -o %%~nf.o
ar.exe -r -s -c --target=pe-bigobj-x86-64 "../avx2/libavutil_x64.a" xtea.o xga_font_data.o video_enc_params.o version.o uuid.o utils.o tx_int32.o tx_float.o tx_double.o tx.o twofish.o tree.o timecode.o time.o threadmessage.o tea.o stereo3d.o spherical.o slicethread.o sha512.o sha.o samplefmt.o ripemd.o rc4.o rational.o random_seed.o reverse.o pixelutils.o pixdesc.o pca.o parseutils.o opt.o murmur3.o mem.o md5.o mathematics.o mastering_display_metadata.o lzo.o log2_tab.o log.o lls.o lfg.o intmath.o integer.o imgutils.o hwcontext_opencl.o hwcontext_dxva2.o hwcontext_d3d11va.o hwcontext.o hmac.o hdr_dynamic_vivid_metadata.o hdr_dynamic_metadata.o hash.o half2float.o frame.o float_dsp.o float2half.o fixed_dsp.o film_grain_params.o file_open.o file.o fifo.o eval.o error.o encryption_info.o downmix_info.o dovi_meta.o display.o dict.o detection_bbox.o des.o csp.o crc.o cpu.o channel_layout.o cast5.o camellia.o buffer.o bprint.o blowfish.o base64.o avstring.o avsscanf.o audio_fifo.o ambient_viewing_environment.o aes_ctr.o aes.o adler32.o x86/cpu.o x86/cpuid.o x86/emms.o x86/fixed_dsp.o x86/fixed_dsp_init.o x86/float_dsp_init.o x86/imgutils.o x86/imgutils_init.o x86/lls_init.o x86/pixelutils.o x86/pixelutils_init.o x86/tx_float.o x86/tx_float_init.o x86/float_dsp.o x86/lls.o
cd ..
cd libswresample/x86
for %%f in ("%~dp1*.asm") do nasm.exe -f win64 -O3 -DARCH_X86_32=0 -DARCH_X86_64=1 -DPIC=1 -DHAVE_ALIGNED_STACK=1 -DHAVE_CPUNOP=0 -DHAVE_MMX_INLINE=0 -DHAVE_MMXEXT_EXTERNAL=1 -DHAVE_SSE2_EXTERNAL=1 -DHAVE_SSSE3_EXTERNAL=1 -DHAVE_AVX_EXTERNAL=1 -DHAVE_FMA3_EXTERNAL=1 -DHAVE_XOP_EXTERNAL=0 -DHAVE_AVX2_EXTERNAL=1 -DHAVE_FMA4_EXTERNAL=0 -DHAVE_AVX512_EXTERNAL=0 -DHAVE_AVX512ICL_EXTERNAL=0 -Xgnu %%f -o %%~nf.o
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
cd ../..
cd libswresample/libsoxr
for %%f in ("soxr.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ../..
cd libswresample
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
ar.exe -r -s -c --target=pe-bigobj-x86-64 "../avx2/libswresample_x64.a" audioconvert.o dither.o options.o rematrix.o resample.o resample_dsp.o soxr_resample.o swresample.o swresample_frame.o version.o libsoxr/soxr.o x86/audio_convert.o x86/rematrix.o x86/resample.o x86/audio_convert_init.o x86/rematrix_init.o x86/resample_init.o
cd ..
cd libswscale/x86
for %%f in ("%~dp1*.asm") do nasm.exe -f win64 -O3 -DARCH_X86_32=0 -DARCH_X86_64=1 -DPIC=1 -DHAVE_ALIGNED_STACK=1 -DHAVE_CPUNOP=0 -DHAVE_MMX_INLINE=0 -DHAVE_MMXEXT_EXTERNAL=1 -DHAVE_SSE2_EXTERNAL=1 -DHAVE_SSSE3_EXTERNAL=1 -DHAVE_AVX_EXTERNAL=1 -DHAVE_FMA3_EXTERNAL=1 -DHAVE_XOP_EXTERNAL=0 -DHAVE_AVX2_EXTERNAL=1 -DHAVE_FMA4_EXTERNAL=0 -DHAVE_AVX512_EXTERNAL=0 -DHAVE_AVX512ICL_EXTERNAL=0 -Xgnu %%f -o %%~nf.o
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
...
cd libswscale
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
ar.exe -r -s -c --target=pe-bigobj-x86-64 "../avx2/libswscale_x64.a" alphablend.o gamma.o hscale.o hscale_fast_bilinear.o input.o options.o output.o rgb2rgb.o slice.o swscale.o swscale_unscaled.o utils.o version.o vscale.o yuv2rgb.o x86/hscale_fast_bilinear_simd.o x86/input.o x86/output.o x86/rgb_2_rgb.o x86/rgb2rgb.o x86/scale.o x86/scale_avx2.o x86/swscale.o x86/yuv_2_rgb.o x86/yuv2rgb.o x86/yuv2yuvX.o
cd ..
cd libavcodec/fixed
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
cd ../..
cd libavcodec/hwcontext
for %%f in ("dxva2*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
cd ../..
cd libavcodec/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
...
cd ..\..
cd core\windows
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -DNHAVE_XINPUT_GAMEPAD_EX -DNHAVE_XINPUT_STATE_EX -c %%f -o %%~nf.o
cd ..\..
cd cpuinfo
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -c %%f -o %%~nf.o
cd ..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -c %%f -o %%~nf.o
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -c %%f -o %%~nf.o
cd ..\..
cd render\opengl
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -static -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -c %%f -o %%~nf.o
cd ..\..
