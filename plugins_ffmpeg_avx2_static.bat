...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/freetype
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -D__FTERRORS_H__=1 -UFTERRORS_H_ -DFT2_BUILD_LIBRARY=1 -DTT_CONFIG_OPTION_COLOR_LAYERS=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/freetype/autofit
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -D__FTERRORS_H__=1 -UFTERRORS_H_ -DFT2_BUILD_LIBRARY=1 -DFT_CONFIG_OPTION_USE_HARFBUZZ=1 -c %%f -o %%~nf.o
cd ../../..
cd librsvg/freetype/bdf
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -D__FTERRORS_H__=1 -UFTERRORS_H_ -DFT2_BUILD_LIBRARY=1 -c %%f -o %%~nf.o
cd ../../..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -D__FTERRORS_H__=1 -UFTERRORS_H_ -DFT2_BUILD_LIBRARY=1 -DWIN32=1 -c %%f -o %%~nf.o
cd ../../..
...
cd ../../..
cd librsvg/fribidi
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DFRIBIDI_LIB_STATIC=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGIZE=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/harfbuzz
for %%f in ("harfbuzz.cc") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -DHAVE_CAIRO=1 -DHAVE_FREETYPE=1 -DHAVE_GLIB=1 -DHAVE_GOBJECT=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/libxml2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/cairo
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/pixman
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DPACKAGE=1 -DUSE_X86_MMX=1 -DUSE_SSE2=1 -DUSE_SSSE3=1 -c %%f -o %%~nf.o
cd ../..

cd librsvg
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DRSVG_STATIC=1 -DRSVG_COMPILATION=1 -c %%f -o %%~nf.o
cd ..
cd librsvg/glib
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DPCRE2_STATIC=1 -DPCRE2_CODE_UNIT_WIDTH=8 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -DPTW32_STATIC_LIB=1 -DHAVE_PTHREAD_CONDATTR_SETCLOCK=1 -DCLOCK_MONOTONIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gio
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gobject
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gdk-pixbuf
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gmodule
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd librsvg/pango
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DFRIBIDI_LIB_STATIC=1 -DLIBXML_STATIC=1 -DSYSCONFDIR=\"/etc\" -DLIBDIR=\"/pango\" -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGIZE=1 -c %%f -o %%~nf.o
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DFRIBIDI_LIB_STATIC=1 -DLIBXML_STATIC=1 -DSYSCONFDIR=\"/etc\" -DLIBDIR=\"/pango\" -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGIZE=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/pcre2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DPCRE2_STATIC=1 -DPCRE2_CODE_UNIT_WIDTH=8 -c %%f -o %%~nf.o
cd ../..
cd librsvg/libcroco
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..
...
cd librsvg/libffi
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
echo for %%f in ("%~dp1*.S") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -c %%f -o %%~nf.o
cd ../..
echo cd librsvg/fnmatch
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
echo cd ../..
echo cd librsvg/libintl
echo for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DNIN_LIBASPRINTF -DNO_XMALLOC -DHAVE_STDINT_H_WITH_UINTMAX -DHAVE_GETCWD -DUSE_WINDOWS_THREADS=1 -DHAVE_MEMPCPY=1 -DHAVE_TSEARCH=1 -DNSTATIC="" -DLOCALEDIR=\"/usr/share/locale\" -DLOCALE_ALIAS_PATH=\"/usr/share/locale/locale.alias\" -DLIBDIR=\"/libintl\" -DIN_LIBINTL -DLIBINTL_VERSION=0x001500 -DNWIDE_CHAR_VERSION -c %%f -o %%~nf.o
echo cd ../..
cd librsvg/libpng
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DPNG_DEBUG=1 -DNZLIB_WINAPI -DPNG_DLL_EXPORT=/"/" -c %%f -o %%~nf.o
cd ../..
cd librsvg/zlib
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DNZLIB_DLL -c %%f -o %%~nf.o
cd ../..
cd librsvg/lzma
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_STDBOOL_H=1 -DHAVE_STDINT_H=1 -DMYTHREAD_ENABLED=1 -DMYTHREAD_VISTA=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/bzip2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DBZ_LCCWIN32=1 -c %%f -o %%~nf.o
cd ../..

cd libtwolame
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DLIBTWOLAME_STATIC=1 -c %%f -o %%~nf.o
cd ..
cd libogg
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ..
cd libtheora/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DCAIRO_WIN32_STATIC_BUILD=1 -DHAVE_CAIRO=1 -DNOC_DUMP_IMAGES -DNOC_COLLECT_METRICS -DNHAVE_MEMORY_CONSTRAINT -DOC_STATE_USE_VTABLE=1 -DOC_X86_ASM=1 -DOC_X86_64_ASM=1 -c %%f -o %%~nf.o
cd ../..
cd libtheora
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DCAIRO_WIN32_STATIC_BUILD=1 -DHAVE_CAIRO=1 -DNOC_DUMP_IMAGES -DNOC_COLLECT_METRICS -DNHAVE_MEMORY_CONSTRAINT -DOC_STATE_USE_VTABLE=1 -DOC_X86_ASM=1 -DOC_X86_64_ASM=1 -c %%f -o %%~nf.o
cd ..
cd libspeex
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DHAVE_SIMD=1 -c %%f -o %%~nf.o
cd ..
cd libsnappy
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_ATTRIBUTE_ALWAYS_INLINE=1 -DHAVE_BUILTIN_CTZ=1 -DHAVE_BUILTIN_EXPECT=1 -DHAVE_BUILTIN_PREFETCH=1 -DSNAPPY_HAVE_SSSE3=1 -DNSNAPPY_HAVE_BMI2 -c %%f -o %%~nf.o
cd ..
cd libshine
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ..
cd libmp3lame
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DSTDC_HEADERS=1 -DNHAVE_ERRNO_H -DHAVE_FCNTL_H=1 -DHAVE_STDINT_H=1 -DNHAVE_NASM -DHAVE_XMMINTRIN_H=1 -DUSE_FAST_LOG=1 -c %%f -o %%~nf.o
cd ..
cd libgsm
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DNeedFunctionPrototypes=1 -DSASR -DWAV49 -c %%f -o %%~nf.o
cd ..
cd libvorbis
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DUSE_MEMORY_H=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -c %%f -o %%~nf.o
cd ..
cd libcelt2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DNUSE_SIMD -c %%f -o %%~nf.o
cd ..
cd libcelt
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DPACKAGE_VERSION=\"1.4.0-82ac57d\" -c %%f -o %%~nf.o
cd ..
cd libcelt/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -c %%f -o %%~nf.o
cd ../..
cd libopus
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -c %%f -o %%~nf.o
cd ..
...
cd ../../..
cd libkvazaar
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DKVZ_BIT_DEPTH=8 -DKVZ_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -c %%f -o %%~nf.o
cd ..
cd libkvazaar/altivec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DKVZ_BIT_DEPTH=8 -DKVZ_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libuvg266
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_BIT_DEPTH=8 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -c %%f -o %%~nf.o
cd ..
cd libuvg266/altivec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_BIT_DEPTH=8 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
cd libuvg266/sse2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_BIT_DEPTH=8 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libpthread_win32
for %%f in ("pthread.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DNHAVE_ERRNO_H -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ..
cd libopenjpeg
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -D__SSE__ -D__SSE2__ -DOPJ_STATIC=1 -DUSE_JPIP -c %%f -o %%~nf.o
cd ..
cd liblcms2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DCMS_IS_WINDOWS_ -DCMS_RELY_ON_WINDOWS_STATIC_MUTEX_INIT -D__LITTLE_ENDIAN__ -c %%f -o %%~nf.o
cd ..
cd libwebp/dec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DWEBP_USE_THREAD -DWEBP_EXTERN=extern -c %%f -o %%~nf.o
cd ../..
cd libwebp/demux
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DWEBP_USE_THREAD -DWEBP_EXTERN=extern -c %%f -o %%~nf.o
cd ../..
...
echo cd ..
cd libfdk-aac
for %%f in ("%~dp1*.cpp") do gcc.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ..
cd libcodec2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ..
cd libxavs
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DNHAVE_MMX -DARCH_X86_64=1 -DNHAVE_MMXEXT -DNHAVE_SSE2 -DNHAVE_SSSE3 -DNHAVE_SSE4 -DXAVS_VERSION=1 -DMP4_OUTPUT=1 -DHAVE_STDINT_H=1 -D__WIN32__=1 -c %%f -o %%~nf.o
cd ..
cd libxavs2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -c %%f -o %%~nf.o
cd ..
cd libxavs2/vec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../../..
cd libdavs2
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=10 -DHIGH_BIT_DEPTH=1 -DHAVE_WIN32THREAD=1 -DSYS_WINDOWS=1 -c %%f -o %%~nf.o
cd ..
cd libdavs2/vec
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=10 -DHIGH_BIT_DEPTH=1 -DHAVE_WIN32THREAD=1 -DSYS_WINDOWS=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../../..
cd libuavs3d
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=0 -DUAVS3D_STATIC=1 -c %%f -o %%~nf.o
cd ..
cd libuavs3d/sse
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=0 -DUAVS3D_STATIC=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libuavs3e
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=0 -DUAVS3E_STATIC=1 -c %%f -o %%~nf.o
cd ..
cd libuavs3e/sse
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=0 -DUAVS3E_STATIC=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libxvid
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_IS_64BIT=1 -DARCH_IS_X86_64=1 -c %%f -o %%~nf.o
cd ..
cd libopenh264/processing
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DX86_ASM -DHAVE_AVX2=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libxevd
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DWINDOWS_MUTEX_SYNC=0 -c %%f -o %%~nf.o
cd ..
cd libxevd/avx2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DWINDOWS_MUTEX_SYNC=0 -c %%f -o %%~nf.o
cd ../..
cd libxeve
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DWINDOWS_MUTEX_SYNC=0 -DENABLE_IBC_CHROMA_REFINE=0 -c %%f -o %%~nf.o
cd ..
cd libxeve/avx2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DWINDOWS_MUTEX_SYNC=0 -DENABLE_IBC_CHROMA_REFINE=0 -c %%f -o %%~nf.o
cd ../..
...
cd libsvtav1
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -c %%f -o %%~nf.o
cd ..
cd libsvtav1/ASM_SSE4_1
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../..
cd libsvtav1/cpuinfo
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNOMINMAX -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -DCPUINFO_MOCK=1 -DCPUINFO_LOG_LEVEL=2 -c %%f -o %%~nf.o
cd ../..
...
cd libaom/aom
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../..
cd libaom/av1c
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DAOM_ARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DBROTLI_HAVE_LOG2=1 -c %%f -o %%~nf.o
cd ../../..
...
cd libjxl
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNJPEGXL_ENABLE_SKCMS -DJXL_DEBUG_WARNING=1 -DJXL_CRASH_ON_ERROR=1 -DJXL_DEBUG_ON_ALL_ERROR=1 -DHWY_COMPILE_ONLY_STATIC -DFJXL_ENABLE_AVX2=1 -DJPEGXL_MAJOR_VERSION=0 -DJPEGXL_MINOR_VERSION=8 -DJPEGXL_PATCH_VERSION=1 -DJPEGXL_VERSION=\"0.9.0-5253e8f\" -c %%f -o %%~nf.o
cd ..
cd libjxl/base
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNJPEGXL_ENABLE_SKCMS -DJXL_DEBUG_WARNING=1 -DJXL_CRASH_ON_ERROR=1 -DJXL_DEBUG_ON_ALL_ERROR=1 -DHWY_COMPILE_ONLY_STATIC -c %%f -o %%~nf.o
cd ../..
...
cd libx264
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=8 -DHIGH_BIT_DEPTH=0 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -DHAVE_X86_INLINE_ASM=1 -c %%f -o %%~nf.o
cd ..
cd libx264_10bit
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_MMX=1 -DARCH_X86_64=1 -DBIT_DEPTH=10 -DHIGH_BIT_DEPTH=1 -DSYS_WINDOWS=1 -DHAVE_THREAD=1 -DHAVE_WIN32THREAD=1 -DHAVE_INTERLACED=1 -DHAVE_STDINT_H=1 -DHAVE_LOG2F=1 -DHAVE_X86_INLINE_ASM=1 -c %%f -o %%~nf.o
cd ..
cd libx265/vec
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -c %%f -o %%~nf.o
...
for %%f in ("soxr.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ../..
cd libswresample
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
...
for %%f in ("dxva2*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
cd ../..
cd libavcodec/x86
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -c %%f -o %%~nf.o
...
cd ../..
cd libavcodec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -DG_LIB_STATIC=1 -DRSVG_STATIC=1 -DKVZ_STATIC_LIB=1 -DUVG_STATIC_LIB=1 -DOPJ_STATIC=1 -DUAVS3D_STATIC=1 -DUAVS3E_STATIC=1 -DLIBTWOLAME_STATIC=1 -c %%f -o %%~nf.o
...
cd ..
cd libavformat
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
...
cd libavfilter
cd libass
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86=1 -DCONFIG_ASM=1 -DCONFIG_FONTCONFIG=1 -DCONFIG_LARGE_TILES=1 -DCONFIG_SOURCEVERSION=\"0.17.1\" -c %%f -o %%~nf.o
cd x86
...
cd ..\..
cd core\windows
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -DNHAVE_XINPUT_GAMEPAD_EX -DNHAVE_XINPUT_STATE_EX -c %%f -o %%~nf.o
cd ..\..
cd cpuinfo
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -c %%f -o %%~nf.o
cd ..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -c %%f -o %%~nf.o
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -c %%f -o %%~nf.o
cd ..\..
cd render\opengl
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -DHAVE_LIBC -c %%f -o %%~nf.o
cd ..\..
