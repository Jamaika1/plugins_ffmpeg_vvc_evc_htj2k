...
cd ../../..
cd librsvg/fribidi
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DFRIBIDI_LIB_STATIC=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGIZE=1 -DDONT_HAVE_FRIBIDI_UNICODE_VERSION_H=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/harfbuzz
for %%f in ("harfbuzz.cc") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DCAIRO_WIN32_STATIC_BUILD=1 -DLIBXML_STATIC=1 -DFRIBIDI_LIB_STATIC=1 -DHAVE_CAIRO=1 -DHAVE_FREETYPE=1 -DNHAVE_GLIB -DNHAVE_GOBJECT -DNDONT_HAVE_FRIBIDI_UNICODE_VERSION_H -c %%f -o %%~nf.o
cd ../..
cd librsvg/libxml2
...
cd librsvg
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DRSVG_STATIC=1 -DRSVG_COMPILATION=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ..
cd librsvg/glib
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DPCRE2_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gio
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DPCRE2_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gobject
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -DPCRE2_STATIC=1 -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gdk-pixbuf
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
cd ../..
cd librsvg/gmodule
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd librsvg/pango
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DFRIBIDI_LIB_STATIC=1 -DLIBXML_STATIC=1 -DSYSCONFDIR=\"/etc\" -DLIBDIR=\"/pango\" -DDONT_HAVE_FRIBIDI_UNICODE_VERSION_H -c %%f -o %%~nf.o
echo for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DFRIBIDI_LIB_STATIC=1 -DLIBXML_STATIC=1 -DSYSCONFDIR=\"/etc\" -DLIBDIR=\"/pango\" -DDONT_HAVE_FRIBIDI_UNICODE_VERSION_H -c %%f -o %%~nf.o
cd ../..
cd librsvg/pcre2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DPCRE2_STATIC=1 -DPCRE2_CODE_UNIT_WIDTH=8 -DHAVE_CONFIG_H -c %%f -o %%~nf.o
cd ../..
cd librsvg/libcroco
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DG_LIB_STATIC=1 -DGLIB_STATIC_COMPILATION=1 -DLIBXML_STATIC=1 -c %%f -o %%~nf.o
cd ../..

cd librsvg/libffi
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DX86_WIN64=1 -DFFI_EFI64=0 -DFFI_UNIX64=0 -DFFI_STATIC_BUILD=1 -c %%f -o %%~nf.o
...
cd ../..
cd librsvg/libintl
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DNIN_LIBASPRINTF -DNO_XMALLOC -DHAVE_CONFIG_H -DHAVE_STDINT_H_WITH_UINTMAX -DHAVE_GETCWD -DUSE_WINDOWS_THREADS=1 -DHAVE_MEMPCPY=1 -DHAVE_TSEARCH=1 -DNSTATIC="" -DLOCALEDIR=\"/usr/share/locale\" -DLOCALE_ALIAS_PATH=\"/usr/share/locale/locale.alias\" -DLIBDIR=\"/libintl\" -DIN_LIBINTL -DLIBINTL_VERSION=0x001308 -DNWIDE_CHAR_VERSION -c %%f -o %%~nf.o
cd ../..
cd librsvg/libpng
...
cd ..
cd libsnappy
for %%f in ("%~dp1*.cc") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DSNAPPY_HAVE_SSSE3=1 -DSNAPPY_HAVE_BMI2=1 -c %%f -o %%~nf.o
cd ..
cd libshine
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -c %%f -o %%~nf.o
cd ..
cd libmp3lame
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DSTDC_HEADERS=1 -DHAVE_ERRNO_H=1 -DHAVE_FCNTL_H=1 -DHAVE_STDINT_H=1 -DNHAVE_NASM -DHAVE_XMMINTRIN_H=1 -DUSE_FAST_LOG=1 -c %%f -o %%~nf.o
cd ..
cd libgsm
...
cd ..
cd libvorbis
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DHAVE_ERRNO_H=1 -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -c %%f -o %%~nf.o
cd ..
cd libcelt2
...
cd ../../..
cd libkvazaar
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DKVZ_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -DHAVE_ERRNO_H=1 -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -c %%f -o %%~nf.o
cd ..
cd libkvazaar/altivec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DKVZ_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libuvg266
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -DHAVE_ERRNO_H=1 -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -c %%f -o %%~nf.o
cd ..
cd libuvg266/altivec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
cd libuvg266/sse2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWIN32 -DWIN64 -DHAVE_CONFIG_H=1 -DUVG_STATIC_LIB=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ../..
...
cd ../..
cd libpthread_win32
for %%f in ("pthread.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_CONFIG_H=1 -DHAVE_ERRNO_H=1 -DHAVE_STDINT_H=1 -D__PTHREAD_JUMBO_BUILD__=1 -DPTW32_STATIC_LIB=1 -c %%f -o %%~nf.o
cd ..
cd libopenjpeg
...
cd ..
cd libxavs
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DXAVS_VERSION=2 -DHAVE_STDINT_H=1 -D__WIN32__=1 -c %%f -o %%~nf.o
cd ..
cd libxavs2
...
cd ../..
cd libuavs3d
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=1 -DUAVS3D_STATIC=1 -c %%f -o %%~nf.o
cd ..
cd libuavs3d/sse
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DARCH_X86_64=1 -DCOMPILE_10BIT=1 -DUAVS3D_STATIC=1 -c %%f -o %%~nf.o
cd ../..
cd libuavs3d/avx2
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DCOMPILE_10BIT=0 -c %%f -o %%~nf.o
cd ../..
cd libuavs3e
...
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DX86_ASM=1 -DHAVE_AVX2=1 -c %%f -o %%~nf.o
cd ../..
cd libopenh264/processing/x86
for %%f in ("%~dp1*.asm") do nasm.exe -f win64 -O3 -DWIN64=1 -DHAVE_AVX2=1 -Xgnu %%f -o %%~nf.o
cd ../../..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DNOMINMAX -DNCONFIG_ACCOUNTING -DARCH_X86_64=1 -DCPUINFO_MOCK=1 -c %%f -o %%~nf.o
cd ../..
...
cd libaom/aom
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../..
cd libaom/av1c
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DARCH_X86_64=1 -c %%f -o %%~nf.o
cd ../..
...
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -DWIN32_LEAN_AND_MEAN=/"/" -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DCONFIG_ACCOUNTING=1 -DCONFIG_INSPECTION=1 -DHAVE_SIMD=1 -DARCH_X86_64=1 -c %%f -o %%~nf.o
for %%f in ("%~dp1*.asm") do nasm.exe -f win64 -O3 -DARCH_X86_64=1 -DCONFIG_PIC=1 -DCONFIG_AV1_ENCODER=1 -DCONFIG_AV1_DECODER=1 -DHAVE_AVX2=1 -Xgnu %%f -o %%~nf.o
cd ../../..
...
cd ../..
cd libx265/vec
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+86-6da609e -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
cd libx265_10bit/vec
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=0 -DX265_NS=x265_10bit -DX86_64=1 -DX265_VERSION=3.5+86-6da609e -DHIGH_BIT_DEPTH=1 -DX265_DEPTH=10 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
cd libx265_12bit/vec
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=0 -DX265_NS=x265_12bit -DX86_64=1 -DX265_VERSION=3.5+86-6da609e -DHIGH_BIT_DEPTH=1 -DX265_DEPTH=12 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
cd libx265
cd x86
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+86-6da609e -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DNX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -DHAVE_STRTOK_R -D_DEBUG=1 -c %%f -o %%~nf.o
...
for %%f in ("%~dp1*.cpp") do g++.exe -std=gnu++11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DWINVER=0x0602 -D_WIN32_WINNT=0x0602 -D_WIN32_WINNT_WIN7=0x0601 -DEXPORT_C_API=1 -DX265_NS=x265 -DLINKED_10BIT=1 -DLINKED_12BIT=1 -DX86_64=1 -DX265_VERSION=3.5+86-6da609e -DHIGH_BIT_DEPTH=0 -DX265_DEPTH=8 -DX265_ARCH_X86=1 -DENABLE_HDR10_PLUS=1 -DENABLE_ASSEMBLY=1 -D_DEBUG=1 -c %%f -o %%~nf.o
cd ../..
...
cd ..
cd libuavs3d
ar.exe rcs "../../lib/libuavs3d_x64.a" alf.o bitstream.o com_table.o com_util.o deblock.o dec_util.o inter_pred.o intra_pred.o inv_trans.o parser.o pic_manager.o recon.o sao.o threadpool.o uavs3d.o win32thread.o sse\alf_sse.o sse\deblock_sse.o sse\inter_pred_sse.o sse\intra_pred_sse.o sse\itrans_sse.o sse\pixel_sse.o sse\sao_sse.o sse\sse.o avx2\alf_avx2.o avx2\avx2.o avx2\inter_pred_avx2.o avx2\intra_pred_avx2.o avx2\itrans_avx2.o avx2\pixel_avx2.o avx2\sao_avx2.o
cd ..
cd libuavs3e
...
cd ../..
cd libavcodec
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -DRSVG_STATIC=1 -DKVZ_STATIC_LIB=1 -DUVG_STATIC_LIB=1 -DOPJ_STATIC=1 -DUAVS3D_STATIC=1 -DUAVS3E_STATIC=1 -DLIBTWOLAME_STATIC=1 -c %%f -o %%~nf.o
...
cd ../..
cd libavfilter
for %%f in ("%~dp1*.c") do gcc.exe -std=gnu11 -march=x86-64-v3 -ftree-vectorize -g0 -O3 -fPIC -mavx2 -mpclmul -maes -mbmi2 -mfma -mf16c -DHAVE_AV_CONFIG_H=1 -DBUILDING_avutil=1 -DFRIBIDI_LIB_STATIC=1 -c %%f -o %%~nf.o
