    ...
    if (env->GetCPUFlags() & CPUF_SSE2) {
      ...
      if (use_weighted_average_f) {
        ...
        case 8:
          ...
          processor_32aligned_ =
#if defined(__AVX2__)
          avx2 ? &weighted_average_avx2<uint8_t, 8> :
#endif
          avx ? &weighted_average_avx<uint8_t, 8> : &weighted_average_sse2<uint8_t, 8>;
          break;
        case 10:
          processor_ = &weighted_average_sse2<uint16_t, 10>;
          processor_32aligned_ =
#if defined(__AVX2__)
          avx2 ? &weighted_average_avx2<uint16_t, 10> :
#endif
          avx ? &weighted_average_avx<uint16_t, 10> : &weighted_average_sse2<uint16_t, 10>;
          break;
        case 12:
          processor_ = &weighted_average_sse2<uint16_t, 12>;
          processor_32aligned_ =
#if defined(__AVX2__)
          avx2 ? &weighted_average_avx2<uint16_t, 12> :
#endif
          avx ? &weighted_average_avx<uint16_t, 12> : &weighted_average_sse2<uint16_t, 12>;
          break;
        case 14:
          processor_ = &weighted_average_sse2<uint16_t, 14>;
          processor_32aligned_ =
#if defined(__AVX2__)
          avx2 ? &weighted_average_avx2<uint16_t, 14> :
#endif
          avx ? &weighted_average_avx<uint16_t, 14> : &weighted_average_sse2<uint16_t, 14>;
          break;
        case 16:
          processor_ = &weighted_average_sse2<uint16_t, 16>;
          processor_32aligned_ =
#if defined(__AVX2__)
          avx2 ? &weighted_average_avx2<uint16_t, 16> :
#endif
          avx ? &weighted_average_avx<uint16_t, 16> : processor_;
          break;
        case 32:
          processor_ = &weighted_average_f_sse2;
          processor_32aligned_ =
#if defined(__AVX2__)
          avx2 ? &weighted_average_f_avx2 :
#endif
          avx ? &weighted_average_f_avx : &weighted_average_f_sse2;
          break;
        }
      }
    }
