...
template<typename pixel_t, SseModeProcessor_3 processor, SseModeProcessor_3 processor_a>
...
template<typename pixel_t, CModeProcessor_3<pixel_t> processor>
...
static RepairPlaneProcessor* r_sse4_functions[] = {
    doNothing,
    copyPlane,
...
static RepairPlaneProcessor* r_sse2_functions[] = {
    doNothing,
    copyPlane,
...
static RepairPlaneProcessor* r_sse4_functions_16_10[] = {
  doNothing,
  copyPlane,
...
static RepairPlaneProcessor* r_sse4_functions_16_12[] = {
  doNothing,
  copyPlane,
  process_plane_sse41<uint16_t, repair_mode1_sse_16<false>,  repair_mode1_sse_16<true>>,
  process_plane_sse41<uint16_t, repair_mode2_sse_16<false>,  repair_mode2_sse_16<true>>,
...
static RepairPlaneProcessor* r_sse4_functions_16_14[] = {
  doNothing,
  copyPlane,
  process_plane_sse41<uint16_t, repair_mode1_sse_16<false>,  repair_mode1_sse_16<true>>,
  process_plane_sse41<uint16_t, repair_mode2_sse_16<false>,  repair_mode2_sse_16<true>>,
...
static RepairPlaneProcessor* r_sse4_functions_16_16[] = {
  doNothing,
  copyPlane,
  process_plane_sse41<uint16_t, repair_mode1_sse_16<false>,  repair_mode1_sse_16<true>>,
  process_plane_sse41<uint16_t, repair_mode2_sse_16<false>,  repair_mode2_sse_16<true>>,
...
static RepairPlaneProcessor* r_sse4_functions_32[] = {
  doNothing,
  copyPlane,
...
static RepairPlaneProcessor* r_sse4_functions_32_chroma[] = {
  doNothing,
  copyPlane,
  process_plane_sse41<float, repair_mode1_sse_32<false>, repair_mode1_sse_32<true>>,
  process_plane_sse41<float, repair_mode2_sse_32<false>, repair_mode2_sse_32<true>>,
...
static RepairPlaneProcessor* r_c_functions[] = {
  doNothing,
  copyPlane,
...
static RepairPlaneProcessor* r_c_functions_10[] = {
  doNothing,
  copyPlane,
...
static RepairPlaneProcessor* r_c_functions_12[] = {
  doNothing,
  copyPlane,
  process_plane_c<uint16_t,repair_mode1_cpp_16>,
  process_plane_c<uint16_t,repair_mode2_cpp_16>,
...
static RepairPlaneProcessor* r_c_functions_14[] = {
  doNothing,
  copyPlane,
  process_plane_c<uint16_t,repair_mode1_cpp_16>,
  process_plane_c<uint16_t,repair_mode2_cpp_16>,
...
static RepairPlaneProcessor* r_c_functions_16[] = {
  doNothing,
  copyPlane,
  process_plane_c<uint16_t,repair_mode1_cpp_16>,
  process_plane_c<uint16_t,repair_mode2_cpp_16>,
...
static RepairPlaneProcessor* r_c_functions_32[] = {
  doNothing,
  copyPlane,
...
static RepairPlaneProcessor* r_c_functions_32_chroma[] = {
  doNothing,
  copyPlane,
  process_plane_c<float,repair_mode1_cpp_32>,
  process_plane_c<float,repair_mode2_cpp_32>,
...
Repair::Repair(PClip child, PClip ref, int mode, int modeU, int modeV, bool skip_cs_check, int opt, IScriptEnvironment* env)
  ...
  if (pixelsize == 1) {
    ...
    functions =
      use_sse41 ? r_sse4_functions :
      use_sse2 ? r_sse2_functions : r_c_functions;

    if (worst_case_width < 17) { //not enough for XMM
      functions = r_c_functions;
    }
  }
  else if (pixelsize == 2) {
    if (use_sse41 && worst_case_width >= (16 / sizeof(uint16_t) + 1)) {
      switch (bits_per_pixel) {
      case 10: functions = r_sse4_functions_16_10; break;
      case 12: functions = r_sse4_functions_16_12; break;
      case 14: functions = r_sse4_functions_16_14; break;
      case 16: functions = r_sse4_functions_16_16; break;
      default: env->ThrowError("Illegal bit-depth: %d!", bits_per_pixel);
      }
    }
    else {
      switch (bits_per_pixel) {
      case 10: functions = r_c_functions_10; break;
      case 12: functions = r_c_functions_12; break;
      case 14: functions = r_c_functions_14; break;
      case 16: functions = r_c_functions_16; break;
      default: env->ThrowError("Illegal bit-depth: %d!", bits_per_pixel);
      }
    }
  }
    ...
    if (use_sse41 && worst_case_width >= (16 / sizeof(float) + 1)) {
      functions = r_sse4_functions_32;
      functions_chroma = r_sse4_functions_32_chroma;
    }
    else {
      functions = r_c_functions_32;
      functions_chroma = r_c_functions_32_chroma;
    }
  }
}
